...
def load_code_arguments(cli_command_loader):
    ...
    with ArgumentsContext(cli_command_loader, 'code push') as ac:
        ac.argument('repository', options_list=('--repository', '-r'))

    with ArgumentsContext(cli_command_loader, 'code push show') as ac:
        ac.argument('include-commits', options_list=('--include-commits', '-c'))
        ac.argument('include-ref-updates', options_list=('--include-ref-updates', '-u'))
