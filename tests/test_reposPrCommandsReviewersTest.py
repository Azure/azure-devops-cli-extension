...
class AzReposPrTests(ScenarioTest):
    ...
    def test_pull_request_createUpdateVoteListAbandonReactivateCompleteReviewers(self):
        ...
        try:
            ...
            #Abandon PR
            abandon_pr_command = 'az repos pr abandon --id ' + create_pr_id + ' --detect false --output json'
            ...
            #Reactivate PR 
            reactivate_pr_command = 'az repos pr reactivate --id ' + create_pr_id + ' --detect false --output json'
            ...
            #Complete PR 
            complete_pr_command = 'az repos pr complete --id ' + create_pr_id + ' --detect false --output json'
