...
class AzureDevTests(ScenarioTest):
    ...
    def test_queryShow(self):
        ...
        show_query_command_with_wiql = 'az boards query -i https://AzureDevOpsCliTest.visualstudio.com -p WorkItemCreateShowUpdateDeleteTests --wiql "' + wiql_string +'" --output json'
