...
class DevopsReposPoliciesTests(ScenarioTest):
    ...
    def test_repos_policies_createUpdateShowListDelete(self):
        ...
        try:
            ...
            create_policy_command = 'az repos policy create --use-squash-merge False --policy-type MergeStrategyPolicy --branch \"refs/heads/master\"' + ' -p ' + created_project_id + ' -r ' + create_repo_id + ' --output json --detect off'
