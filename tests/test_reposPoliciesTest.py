...
class DevopsReposPoliciesTests(ScenarioTest):
    ...
    def test_repos_policies_createUpdateShowListDelete(self):
        ...
        try:
            ...
            show_policy_command = 'az repos policies show --id ' + str(policy_id) + ' -p ' + created_project_id + ' --output json --detect off'
            ...
            update_policy_command = 'az repos policies update --policy-id ' + str(policy_id) + ' --useSquashMerge True --policy-type MergeStrategyPolicy --branch \"refs/heads/master\"' + ' -p ' + created_project_id + ' -r ' + create_repo_id + ' --output json --detect off'
            ...
            delete_policy_command = 'az repos policies delete --id ' + str(policy_id) + ' -p ' + created_project_id + ' --output json --detect off -y'
