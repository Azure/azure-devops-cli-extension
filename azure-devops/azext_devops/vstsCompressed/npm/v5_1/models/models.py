...
class NpmPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <npm.v5_1.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <npm.v5_1.models.MinimalPackageDetails>`
    """
...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <npm.v5_1.models.ReferenceLinks>`
    ...
    :type source_chain: list of :class:`UpstreamSourceInfo <npm.v5_1.models.UpstreamSourceInfo>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <npm.v5_1.models.JsonPatchOperation>`
    """
