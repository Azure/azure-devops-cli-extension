...
class ContributionsClient(VssClient):
    ...
    def query_contribution_nodes(self, query):
        ...
        :param :class:`<ContributionNodeQuery> <contributions.v5_1.models.ContributionNodeQuery>` query:
        :rtype: :class:`<ContributionNodeQueryResult> <contributions.v5_1.models.ContributionNodeQueryResult>`
        """
    ...
    def query_data_providers(self, query, scope_name=None, scope_value=None):
        """QueryDataProviders.
        [Preview API]
        :param :class:`<DataProviderQuery> <contributions.v5_1.models.DataProviderQuery>` query:
        :param str scope_name:
        :param str scope_value:
        :rtype: :class:`<DataProviderResult> <contributions.v5_1.models.DataProviderResult>`
        """
        route_values = {}
    ...
    def get_installed_extension_by_name(self, publisher_name, extension_name, asset_types=None):
        ...
        :param [str] asset_types:
        :rtype: :class:`<InstalledExtension> <contributions.v5_1.models.InstalledExtension>`
        """
        route_values = {}
