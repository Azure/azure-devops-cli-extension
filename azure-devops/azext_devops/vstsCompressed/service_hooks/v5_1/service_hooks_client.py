...
class ServiceHooksClient(VssClient):
    ...
    def get_consumer_action(self, consumer_id, consumer_action_id, publisher_id=None):
        ...
        :rtype: :class:`<ConsumerAction> <service-hooks.v5_1.models.ConsumerAction>`
        """
        route_values = {}
    ...
    def get_consumer(self, consumer_id, publisher_id=None):
        ...
        :param str consumer_id: ID for a consumer.
        :param str publisher_id:
        :rtype: :class:`<Consumer> <service-hooks.v5_1.models.Consumer>`
        """
        route_values = {}
        if consumer_id is not None:
            route_values['consumerId'] = self._serialize.url('consumer_id', consumer_id, 'str')
    ...
    def get_subscription_diagnostics(self, subscription_id):
        ...
        :rtype: :class:`<SubscriptionDiagnostics> <service-hooks.v5_1.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def update_subscription_diagnostics(self, update_parameters, subscription_id):
        ...
        [Preview API]
        :param :class:`<UpdateSubscripitonDiagnosticsParameters> <service-hooks.v5_1.models.UpdateSubscripitonDiagnosticsParameters>` update_parameters:
        :param str subscription_id:
        :rtype: :class:`<SubscriptionDiagnostics> <service-hooks.v5_1.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def get_event_type(self, publisher_id, event_type_id):
        ...
        :rtype: :class:`<EventTypeDescriptor> <service-hooks.v5_1.models.EventTypeDescriptor>`
        """
        route_values = {}
        if publisher_id is not None:
    ...
    def get_notification(self, subscription_id, notification_id):
        ...
        :rtype: :class:`<Notification> <service-hooks.v5_1.models.Notification>`
        """
        route_values = {}
        if subscription_id is not None:
            route_values['subscriptionId'] = self._serialize.url('subscription_id', subscription_id, 'str')
    ...
    def query_notifications(self, query):
        ...
        :param :class:`<NotificationsQuery> <service-hooks.v5_1.models.NotificationsQuery>` query:
        :rtype: :class:`<NotificationsQuery> <service-hooks.v5_1.models.NotificationsQuery>`
        """
    ...
    def query_input_values(self, input_values_query, publisher_id):
        """QueryInputValues.
        [Preview API]
        :param :class:`<InputValuesQuery> <service-hooks.v5_1.models.InputValuesQuery>` input_values_query:
        :param str publisher_id:
        :rtype: :class:`<InputValuesQuery> <service-hooks.v5_1.models.InputValuesQuery>`
        """
        route_values = {}
        if publisher_id is not None:
            route_values['publisherId'] = self._serialize.url('publisher_id', publisher_id, 'str')
    ...
    def get_publisher(self, publisher_id):
        ...
        :param str publisher_id: ID for a publisher.
        :rtype: :class:`<Publisher> <service-hooks.v5_1.models.Publisher>`
        """
        route_values = {}
        if publisher_id is not None:
            route_values['publisherId'] = self._serialize.url('publisher_id', publisher_id, 'str')
    ...
    def query_publishers(self, query):
        ...
        :param :class:`<PublishersQuery> <service-hooks.v5_1.models.PublishersQuery>` query:
        :rtype: :class:`<PublishersQuery> <service-hooks.v5_1.models.PublishersQuery>`
        """
    ...
    def create_subscription(self, subscription):
        ...
        :param :class:`<Subscription> <service-hooks.v5_1.models.Subscription>` subscription: Subscription to be created.
        :rtype: :class:`<Subscription> <service-hooks.v5_1.models.Subscription>`
        """
    ...
    def replace_subscription(self, subscription, subscription_id=None):
        ...
        :param :class:`<Subscription> <service-hooks.v5_1.models.Subscription>` subscription:
        :param str subscription_id:
        :rtype: :class:`<Subscription> <service-hooks.v5_1.models.Subscription>`
        """
        route_values = {}
    ...
    def create_subscriptions_query(self, query):
        ...
        :param :class:`<SubscriptionsQuery> <service-hooks.v5_1.models.SubscriptionsQuery>` query:
        :rtype: :class:`<SubscriptionsQuery> <service-hooks.v5_1.models.SubscriptionsQuery>`
        """
    ...
    def create_test_notification(self, test_notification, use_real_data=None):
        ...
        :param :class:`<Notification> <service-hooks.v5_1.models.Notification>` test_notification:
