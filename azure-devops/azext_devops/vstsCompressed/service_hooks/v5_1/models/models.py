...
class Consumer(Model):
    ...
    :type _links: :class:`ReferenceLinks <service-hooks.v5_1.models.ReferenceLinks>`
    :param actions: Gets this consumer's actions.
    :type actions: list of :class:`ConsumerAction <service-hooks.v5_1.models.ConsumerAction>`
    ...
    :type external_configuration: :class:`ExternalConfigurationDescriptor <service-hooks.v5_1.models.ExternalConfigurationDescriptor>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <service-hooks.v5_1.models.InputDescriptor>`
...
class Event(Model):
    ...
    :type detailed_message: :class:`FormattedEventMessage <service-hooks.v5_1.models.FormattedEventMessage>`
    ...
    :type message: :class:`FormattedEventMessage <service-hooks.v5_1.models.FormattedEventMessage>`
    ...
    :type session_token: :class:`SessionToken <service-hooks.v5_1.models.SessionToken>`
    """
...
class InputFilter(Model):
    ...
    :type conditions: list of :class:`InputFilterCondition <microsoft.-visual-studio.-services.-web-api.v5_1.models.InputFilterCondition>`
    """
...
class Notification(Model):
    ...
    :type details: :class:`NotificationDetails <service-hooks.v5_1.models.NotificationDetails>`
...
class NotificationsQuery(Model):
    ...
    :type associated_subscriptions: list of :class:`Subscription <service-hooks.v5_1.models.Subscription>`
    ...
    :type results: list of :class:`Notification <service-hooks.v5_1.models.Notification>`
    ...
    :type summary: list of :class:`NotificationSummary <service-hooks.v5_1.models.NotificationSummary>`
    """
...
class NotificationDetails(Model):
    ...
    :type event: :class:`Event <service-hooks.v5_1.models.Event>`
...
class NotificationSummary(Model):
    ...
    :type results: list of :class:`NotificationResultsSummaryDetail <service-hooks.v5_1.models.NotificationResultsSummaryDetail>`
    :param subscription_id: The subscription id associated with this notification
    :type subscription_id: str
    """
...
class Publisher(Model):
    ...
    :type supported_events: list of :class:`EventTypeDescriptor <service-hooks.v5_1.models.EventTypeDescriptor>`
    :param url: The url for this resource
    :type url: str
    """
...
class PublishersQuery(Model):
    ...
    :type publisher_inputs: dict
    :param results: Results from the query
    :type results: list of :class:`Publisher <service-hooks.v5_1.models.Publisher>`
    """
...
class PublisherEvent(Model):
    ...
    :type other_resource_versions: list of :class:`VersionedResource <service-hooks.v5_1.models.VersionedResource>`
    ...
    :type publisher_input_filters: list of :class:`InputFilter <service-hooks.v5_1.models.InputFilter>`
    :param subscription: Gets or sets matchd hooks subscription which caused this event.
    :type subscription: :class:`Subscription <service-hooks.v5_1.models.Subscription>`
    """
...
class Subscription(Model):
    ...
    :type consumer_inputs: dict
    :param created_by:
    :type created_by: :class:`IdentityRef <service-hooks.v5_1.models.IdentityRef>`
    :param created_date:
    :type created_date: datetime
    ...
    :type id: str
    :param modified_by:
    :type modified_by: :class:`IdentityRef <service-hooks.v5_1.models.IdentityRef>`
    :param modified_date:
    :type modified_date: datetime
    ...
    :type status: object
    :param subscriber:
    :type subscriber: :class:`IdentityRef <service-hooks.v5_1.models.IdentityRef>`
    :param url:
    :type url: str
    """
...
class SubscriptionsQuery(Model):
    ...
    :type consumer_input_filters: list of :class:`InputFilter <service-hooks.v5_1.models.InputFilter>`
    ...
    :type publisher_input_filters: list of :class:`InputFilter <service-hooks.v5_1.models.InputFilter>`
    :param results: Results from the query
    :type results: list of :class:`Subscription <service-hooks.v5_1.models.Subscription>`
...
class SubscriptionDiagnostics(Model):
    ...
    :type delivery_results: :class:`SubscriptionTracing <microsoft.-visual-studio.-services.-notifications.-web-api.v5_1.models.SubscriptionTracing>`
    :param delivery_tracing:
    :type delivery_tracing: :class:`SubscriptionTracing <microsoft.-visual-studio.-services.-notifications.-web-api.v5_1.models.SubscriptionTracing>`
    :param evaluation_tracing:
    :type evaluation_tracing: :class:`SubscriptionTracing <microsoft.-visual-studio.-services.-notifications.-web-api.v5_1.models.SubscriptionTracing>`
    """
...
class UpdateSubscripitonDiagnosticsParameters(Model):
    ...
    :param delivery_results:
    :type delivery_results: :class:`UpdateSubscripitonTracingParameters <microsoft.-visual-studio.-services.-notifications.-web-api.v5_1.models.UpdateSubscripitonTracingParameters>`
    :param delivery_tracing:
    :type delivery_tracing: :class:`UpdateSubscripitonTracingParameters <microsoft.-visual-studio.-services.-notifications.-web-api.v5_1.models.UpdateSubscripitonTracingParameters>`
    :param evaluation_tracing:
    :type evaluation_tracing: :class:`UpdateSubscripitonTracingParameters <microsoft.-visual-studio.-services.-notifications.-web-api.v5_1.models.UpdateSubscripitonTracingParameters>`
    """
