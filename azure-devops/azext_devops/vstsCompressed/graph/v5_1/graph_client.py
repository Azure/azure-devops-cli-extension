...
class GraphClient(VssClient):
    ...
    def get_descriptor(self, storage_key):
        ...
        :rtype: :class:`<GraphDescriptorResult> <graph.v5_1.models.GraphDescriptorResult>`
        """
        route_values = {}
    ...
    def create_group(self, creation_context, scope_descriptor=None, group_descriptors=None):
        ...
        :param :class:`<GraphGroupCreationContext> <graph.v5_1.models.GraphGroupCreationContext>` creation_context: The subset of the full graph group used to uniquely find the graph subject in an external provider.
        ...
        :rtype: :class:`<GraphGroup> <graph.v5_1.models.GraphGroup>`
        """
        query_parameters = {}
    ...
    def list_groups(self, scope_descriptor=None, subject_types=None, continuation_token=None):
        ...
        :rtype: :class:`<PagedGraphGroups> <graph.v5_1.models.PagedGraphGroups>`
        """
        query_parameters = {}
        if scope_descriptor is not None:
            query_parameters['scopeDescriptor'] = self._serialize.query('scope_descriptor', scope_descriptor, 'str')
    ...
    def update_group(self, group_descriptor, patch_document):
        ...
        :param :class:`<[JsonPatchOperation]> <graph.v5_1.models.[JsonPatchOperation]>` patch_document: The JSON+Patch document containing the fields to alter.
        :rtype: :class:`<GraphGroup> <graph.v5_1.models.GraphGroup>`
        """
        route_values = {}
        if group_descriptor is not None:
    ...
    def add_membership(self, subject_descriptor, container_descriptor):
        ...
        :rtype: :class:`<GraphMembership> <graph.v5_1.models.GraphMembership>`
        """
        route_values = {}
    ...
    def get_membership_state(self, subject_descriptor):
        ...
        :rtype: :class:`<GraphMembershipState> <graph.v5_1.models.GraphMembershipState>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def get_provider_info(self, user_descriptor):
        ...
        :rtype: :class:`<GraphProviderInfo> <graph.v5_1.models.GraphProviderInfo>`
        """
        route_values = {}
    ...
    def get_storage_key(self, subject_descriptor):
        ...
        :rtype: :class:`<GraphStorageKeyResult> <graph.v5_1.models.GraphStorageKeyResult>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def lookup_subjects(self, subject_lookup):
        ...
        :param :class:`<GraphSubjectLookup> <graph.v5_1.models.GraphSubjectLookup>` subject_lookup: A list of descriptors that specifies a subset of subjects to retrieve. Each descriptor uniquely identifies the subject across all instance scopes, but only at a single point in time.
        :rtype: {GraphSubject}
        """
    ...
    def create_user(self, creation_context, group_descriptors=None):
        ...
        :param :class:`<GraphUserCreationContext> <graph.v5_1.models.GraphUserCreationContext>` creation_context: The subset of the full graph user used to uniquely find the graph subject in an external provider.
        :param [str] group_descriptors: A comma separated list of descriptors of groups you want the graph user to join
        :rtype: :class:`<GraphUser> <graph.v5_1.models.GraphUser>`
        """
        query_parameters = {}
        if group_descriptors is not None:
            group_descriptors = ",".join(group_descriptors)
    ...
    def list_users(self, subject_types=None, continuation_token=None):
        ...
        :param str continuation_token: An opaque data blob that allows the next page of data to resume immediately after where the previous page ended. The only reliable way to know if there is more data left is the presence of a continuation token.
        :rtype: :class:`<PagedGraphUsers> <graph.v5_1.models.PagedGraphUsers>`
        """
        query_parameters = {}
        if subject_types is not None:
            subject_types = ",".join(subject_types)
