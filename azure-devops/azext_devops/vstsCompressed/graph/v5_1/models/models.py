...
class GraphDescriptorResult(Model):
    ...
    :type _links: :class:`ReferenceLinks <graph.v5_1.models.ReferenceLinks>`
    :param value:
    :type value: :class:`str <graph.v5_1.models.str>`
    """
...
class GraphMembershipTraversal(Model):
    ...
    :type subject_descriptor: :class:`str <graph.v5_1.models.str>`
    ...
    :type traversed_subjects: list of :class:`str <graph.v5_1.models.str>`
    """
...
class GraphSubjectLookup(Model):
    ...
    :param lookup_keys:
    :type lookup_keys: list of :class:`GraphSubjectLookupKey <graph.v5_1.models.GraphSubjectLookupKey>`
    """
...
class GraphSubjectLookupKey(Model):
    ...
    :param descriptor:
    :type descriptor: :class:`str <graph.v5_1.models.str>`
    """
...
class PagedGraphGroups(Model):
    ...
    :type graph_groups: list of :class:`GraphGroup <graph.v5_1.models.GraphGroup>`
    """
...
class PagedGraphUsers(Model):
    ...
    :type graph_users: list of :class:`GraphUser <graph.v5_1.models.GraphUser>`
    """
