...
class PlanEnvironment(Model):
    ...
    :param mask:
    :type mask: list of :class:`MaskHint <task.v5_1.models.MaskHint>`
    :param options:
    :type options: dict
    :param variables:
    :type variables: dict
...
class TaskAttachment(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <task.v5_1.models.ReferenceLinks>`
    :param created_on:
...
class TaskOrchestrationPlanReference(Model):
    ...
    :param definition:
    :type definition: :class:`TaskOrchestrationOwner <task.v5_1.models.TaskOrchestrationOwner>`
    :param owner:
    :type owner: :class:`TaskOrchestrationOwner <task.v5_1.models.TaskOrchestrationOwner>`
    :param plan_group:
    :type plan_group: str
    :param plan_id:
    :type plan_id: str
...
class TaskOrchestrationQueuedPlanGroup(Model):
    ...
    :type plan_group: str
    :param plans:
    :type plans: list of :class:`TaskOrchestrationQueuedPlan <task.v5_1.models.TaskOrchestrationQueuedPlan>`
    :param project:
    :type project: :class:`ProjectReference <task.v5_1.models.ProjectReference>`
    :param queue_position:
    :type queue_position: int
    """
...
class TimelineRecord(Model):
    ...
    :param details:
    :type details: :class:`TimelineReference <task.v5_1.models.TimelineReference>`
    :param error_count:
    ...
    :type identifier: str
    :param issues:
    :type issues: list of :class:`Issue <task.v5_1.models.Issue>`
    :param last_modified:
    :type last_modified: datetime
    :param location:
    :type location: str
    :param log:
    :type log: :class:`TaskLogReference <task.v5_1.models.TaskLogReference>`
    :param name:
    :type name: str
    :param order:
    :type order: int
    ...
    :type previous_attempts: list of :class:`TimelineAttempt <task.v5_1.models.TimelineAttempt>`
    :param ref_name:
    :type ref_name: str
    :param result:
    :type result: object
    ...
    :type state: object
    :param task:
    :type task: :class:`TaskReference <task.v5_1.models.TaskReference>`
    :param type:
    :type type: str
    :param variables:
    :type variables: dict
...
class TaskOrchestrationContainer(TaskOrchestrationItem):
    ...
    :type item_type: object
    :param children:
    :type children: list of :class:`TaskOrchestrationItem <task.v5_1.models.TaskOrchestrationItem>`
    ...
    :type parallel: bool
    :param rollback:
    :type rollback: :class:`TaskOrchestrationContainer <task.v5_1.models.TaskOrchestrationContainer>`
    """
...
class TaskOrchestrationPlan(TaskOrchestrationPlanReference):
    ...
    :type version: int
    :param environment:
    :type environment: :class:`PlanEnvironment <task.v5_1.models.PlanEnvironment>`
    :param finish_time:
    :type finish_time: datetime
    :param implementation:
    :type implementation: :class:`TaskOrchestrationContainer <task.v5_1.models.TaskOrchestrationContainer>`
    :param initialization_log:
    :type initialization_log: :class:`TaskLogReference <task.v5_1.models.TaskLogReference>`
    ...
    :type state: object
    :param timeline:
    :type timeline: :class:`TimelineReference <task.v5_1.models.TimelineReference>`
    """
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <task.v5_1.models.TimelineRecord>`
    """
