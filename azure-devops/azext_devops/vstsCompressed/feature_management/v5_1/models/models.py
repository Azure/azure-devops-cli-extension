...
class ContributedFeature(Model):
    ...
    :type _links: :class:`ReferenceLinks <feature-management.v5_1.models.ReferenceLinks>`
    ...
    :type default_value_rules: list of :class:`ContributedFeatureValueRule <feature-management.v5_1.models.ContributedFeatureValueRule>`
    ...
    :type feature_state_changed_listeners: list of :class:`ContributedFeatureListener <feature-management.v5_1.models.ContributedFeatureListener>`
    ...
    :type override_rules: list of :class:`ContributedFeatureValueRule <feature-management.v5_1.models.ContributedFeatureValueRule>`
    :param scopes: The scopes/levels at which settings can set the enabled/disabled state of this feature
    :type scopes: list of :class:`ContributedFeatureSettingScope <feature-management.v5_1.models.ContributedFeatureSettingScope>`
...
class ContributedFeatureState(Model):
    ...
    :type scope: :class:`ContributedFeatureSettingScope <feature-management.v5_1.models.ContributedFeatureSettingScope>`
