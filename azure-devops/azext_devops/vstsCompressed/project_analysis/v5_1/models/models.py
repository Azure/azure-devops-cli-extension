...
class ProjectActivityMetrics(Model):
    ...
    :type code_changes_trend: list of :class:`CodeChangeTrendItem <project-analysis.v5_1.models.CodeChangeTrendItem>`
    :param project_id:
    :type project_id: str
...
class ProjectLanguageAnalytics(LanguageMetricsSecuredObject):
    ...
    :type language_breakdown: list of :class:`LanguageStatistics <project-analysis.v5_1.models.LanguageStatistics>`
    :param repository_language_analytics:
    :type repository_language_analytics: list of :class:`RepositoryLanguageAnalytics <project-analysis.v5_1.models.RepositoryLanguageAnalytics>`
    :param result_phase:
