...
class PipelinesClient(VssClient):
    """Pipelines
    ...
    def get_configurations(self, project, repository_type=None, repository_id=None, branch=None, service_connection_id=None):
        """GetConfigurations.
        [Preview API] Gets a list of exisiting configuration files for the given repository.
    ...
    def create_connection(self, create_connection_inputs):
        ...
        :param :class:`<CreatePipelineConnectionInputs> <pipelines.v5_1.models.CreatePipelineConnectionInputs>` create_connection_inputs:
        :rtype: :class:`<Operation> <pipelines.v5_1.models.Operation>`
        """
    ...
    def create_project_connection(self, create_connection_inputs, project):
        ...
        :param :class:`<CreatePipelineConnectionInputs> <pipelines.v5_1.models.CreatePipelineConnectionInputs>` create_connection_inputs:
        :param str project:
        :rtype: :class:`<PipelineConnection> <pipelines.v5_1.models.PipelineConnection>`
        """
        query_parameters = {}
        if project is not None:
    ...
    def get_recommended_templates(self, project, repository_type=None, repository_id=None, branch=None, service_connection_id=None):
        """GetRecommendedTemplates.
        [Preview API] Finds a list of YAML templates that would best fit the given repository based on its contents. If no matches are found, a default empty YAML template will be returned.
        :param str project: Project ID or project name
        :param str repository_type: The type of the repository such as GitHub, TfsGit (i.e. Azure Repos), Bitbucket, etc.
        :param str repository_id: The vendor-specific identifier or the name of the repository, e.g. Microsoft/vscode (GitHub) or e9d82045-ddba-4e01-a63d-2ab9f040af62 (Azure Repos)
    ...
    def render_template(self, template_parameters, template_id):
        """RenderTemplate.
        [Preview API]
        :param :class:`<TemplateParameters> <pipelines.v5_1.models.TemplateParameters>` template_parameters:
        :param str template_id:
        :rtype: :class:`<Template> <pipelines.v5_1.models.Template>`
        """
        route_values = {}
