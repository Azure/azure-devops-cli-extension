...
class CreatePipelineConnectionInputs(Model):
    ...
    :type project: :class:`TeamProject <pipelines.v5_1.models.TeamProject>`
...
class Template(Model):
    ...
    :type name: str
    :param parameters:
    :type parameters: list of :class:`TemplateParameterDefinition <pipelines.v5_1.models.TemplateParameterDefinition>`
...
class Operation(OperationReference):
    ...
    :param result_url: URL to the operation result.
    :type result_url: :class:`OperationResultReference <microsoft.-visual-studio.-services.-web-api.v5_1.models.OperationResultReference>`
    """
...
class TeamProject(TeamProjectReference):
    ...
    :type _links: :class:`ReferenceLinks <microsoft.-team-foundation.-core.-web-api.v5_1.models.ReferenceLinks>`
    ...
    :type default_team: :class:`WebApiTeamRef <microsoft.-team-foundation.-core.-web-api.v5_1.models.WebApiTeamRef>`
    """
