...
class Operation(OperationReference):
    ...
    :type _links: :class:`ReferenceLinks <operations.v5_1.models.ReferenceLinks>`
    ...
    :param result_url: URL to the operation result.
    :type result_url: :class:`OperationResultReference <operations.v5_1.models.OperationResultReference>`
    """
