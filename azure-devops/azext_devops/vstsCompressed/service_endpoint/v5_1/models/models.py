...
class AzureManagementGroupQueryResult(Model):
    ...
    :type value: list of :class:`AzureManagementGroup <service-endpoint.v5_1.models.AzureManagementGroup>`
    """
...
class AzureSubscriptionQueryResult(Model):
    ...
    :type error_message: str
    :param value:
    :type value: list of :class:`AzureSubscription <service-endpoint.v5_1.models.AzureSubscription>`
    """
...
class DataSource(Model):
    ...
    :type authentication_scheme: :class:`AuthenticationSchemeReference <service-endpoint.v5_1.models.AuthenticationSchemeReference>`
    ...
    :param headers:
    :type headers: list of :class:`AuthorizationHeader <service-endpoint.v5_1.models.AuthorizationHeader>`
...
class DependsOn(Model):
    ...
    :type input: str
    :param map:
    :type map: list of :class:`DependencyBinding <service-endpoint.v5_1.models.DependencyBinding>`
    """
...
class EndpointUrl(Model):
    ...
    :type depends_on: :class:`DependsOn <service-endpoint.v5_1.models.DependsOn>`
...
class OAuthConfiguration(Model):
    ...
    :type created_by: :class:`IdentityRef <service-endpoint.v5_1.models.IdentityRef>`
    ...
    :type modified_by: :class:`IdentityRef <service-endpoint.v5_1.models.IdentityRef>`
...
class ServiceEndpoint(Model):
    ...
    :type administrators_group: :class:`IdentityRef <service-endpoint.v5_1.models.IdentityRef>`
    :param authorization: Gets or sets the authorization data for talking to the endpoint.
    :type authorization: :class:`EndpointAuthorization <service-endpoint.v5_1.models.EndpointAuthorization>`
    ...
    :type operation_status: :class:`object <service-endpoint.v5_1.models.object>`
    ...
    :type readers_group: :class:`IdentityRef <service-endpoint.v5_1.models.IdentityRef>`
...
class ServiceEndpointAuthenticationScheme(Model):
    ...
    :type authorization_headers: list of :class:`AuthorizationHeader <service-endpoint.v5_1.models.AuthorizationHeader>`
    ...
    :type client_certificates: list of :class:`ClientCertificate <service-endpoint.v5_1.models.ClientCertificate>`
    :param data_source_bindings:
    :type data_source_bindings: list of :class:`DataSourceBinding <service-endpoint.v5_1.models.DataSourceBinding>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <service-endpoint.v5_1.models.InputDescriptor>`
...
class ServiceEndpointExecutionData(Model):
    ...
    :type definition: :class:`ServiceEndpointExecutionOwner <service-endpoint.v5_1.models.ServiceEndpointExecutionOwner>`
    ...
    :type owner: :class:`ServiceEndpointExecutionOwner <service-endpoint.v5_1.models.ServiceEndpointExecutionOwner>`
...
class ServiceEndpointExecutionOwner(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <service-endpoint.v5_1.models.ReferenceLinks>`
...
class ServiceEndpointExecutionRecord(Model):
    ...
    :type data: :class:`ServiceEndpointExecutionData <service-endpoint.v5_1.models.ServiceEndpointExecutionData>`
...
class ServiceEndpointRequest(Model):
    ...
    :type data_source_details: :class:`DataSourceDetails <service-endpoint.v5_1.models.DataSourceDetails>`
    :param result_transformation_details: Gets or sets the result transformation details for the service endpoint request.
    :type result_transformation_details: :class:`ResultTransformationDetails <service-endpoint.v5_1.models.ResultTransformationDetails>`
    :param service_endpoint_details: Gets or sets the service endpoint details for the service endpoint request.
    :type service_endpoint_details: :class:`ServiceEndpointDetails <service-endpoint.v5_1.models.ServiceEndpointDetails>`
    """
...
class ServiceEndpointRequestResult(Model):
    ...
    :type result: :class:`object <service-endpoint.v5_1.models.object>`
...
class ServiceEndpointType(Model):
    ...
    :type authentication_schemes: list of :class:`ServiceEndpointAuthenticationScheme <service-endpoint.v5_1.models.ServiceEndpointAuthenticationScheme>`
    :param data_sources: Data sources of service endpoint type.
    :type data_sources: list of :class:`DataSource <service-endpoint.v5_1.models.DataSource>`
    :param dependency_data: Dependency data of service endpoint type.
    :type dependency_data: list of :class:`DependencyData <service-endpoint.v5_1.models.DependencyData>`
    ...
    :type endpoint_url: :class:`EndpointUrl <service-endpoint.v5_1.models.EndpointUrl>`
    :param help_link: Gets or sets the help link of service endpoint type.
    :type help_link: :class:`HelpLink <service-endpoint.v5_1.models.HelpLink>`
