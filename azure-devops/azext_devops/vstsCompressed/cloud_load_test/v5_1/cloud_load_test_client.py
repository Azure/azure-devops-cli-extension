...
class CloudLoadTestClient(VssClient):
    ...
    def create_agent_group(self, group):
        """CreateAgentGroup.
        [Preview API]
        :param :class:`<AgentGroup> <cloud-load-test.v5_1.models.AgentGroup>` group: Agent group to be created
        :rtype: :class:`<AgentGroup> <cloud-load-test.v5_1.models.AgentGroup>`
        """
    ...
    def get_application(self, application_id):
        ...
        :rtype: :class:`<Application> <cloud-load-test.v5_1.models.Application>`
        """
        route_values = {}
    ...
    def get_counter_samples(self, counter_sample_query_details, test_run_id):
        """GetCounterSamples.
        [Preview API]
        :param :class:`<VssJsonCollectionWrapper> <cloud-load-test.v5_1.models.VssJsonCollectionWrapper>` counter_sample_query_details:
        :param str test_run_id: The test run identifier
        :rtype: :class:`<CounterSamplesResult> <cloud-load-test.v5_1.models.CounterSamplesResult>`
        """
        route_values = {}
        if test_run_id is not None:
            route_values['testRunId'] = self._serialize.url('test_run_id', test_run_id, 'str')
    ...
    def get_load_test_run_errors(self, test_run_id, type=None, sub_type=None, detailed=None):
        ...
        :rtype: :class:`<LoadTestErrors> <cloud-load-test.v5_1.models.LoadTestErrors>`
        """
        route_values = {}
        if test_run_id is not None:
            route_values['testRunId'] = self._serialize.url('test_run_id', test_run_id, 'str')
    ...
    def get_plugin(self, type):
        ...
        :rtype: :class:`<ApplicationType> <cloud-load-test.v5_1.models.ApplicationType>`
        """
        route_values = {}
        if type is not None:
    ...
    def get_load_test_result(self, test_run_id):
        ...
        [Preview API]
        :param str test_run_id: The test run identifier
        :rtype: :class:`<TestResults> <cloud-load-test.v5_1.models.TestResults>`
        """
        route_values = {}
        if test_run_id is not None:
            route_values['testRunId'] = self._serialize.url('test_run_id', test_run_id, 'str')
    ...
    def create_test_definition(self, test_definition):
        ...
        [Preview API]
        :param :class:`<TestDefinition> <cloud-load-test.v5_1.models.TestDefinition>` test_definition: Test definition to be created
        :rtype: :class:`<TestDefinition> <cloud-load-test.v5_1.models.TestDefinition>`
        """
    ...
    def update_test_definition(self, test_definition):
        ...
        [Preview API]
        :param :class:`<TestDefinition> <cloud-load-test.v5_1.models.TestDefinition>` test_definition:
        :rtype: :class:`<TestDefinition> <cloud-load-test.v5_1.models.TestDefinition>`
        """
        content = self._serialize.body(test_definition, 'TestDefinition')
    ...
    def create_test_drop(self, web_test_drop):
        """CreateTestDrop.
        [Preview API]
        :param :class:`<TestDrop> <cloud-load-test.v5_1.models.TestDrop>` web_test_drop: Test drop to be created
        :rtype: :class:`<TestDrop> <cloud-load-test.v5_1.models.TestDrop>`
        """
    ...
    def create_test_run(self, web_test_run):
        """CreateTestRun.
        [Preview API]
        :param :class:`<TestRun> <cloud-load-test.v5_1.models.TestRun>` web_test_run:
        :rtype: :class:`<TestRun> <cloud-load-test.v5_1.models.TestRun>`
        """
