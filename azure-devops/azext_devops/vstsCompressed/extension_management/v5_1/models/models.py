...
class AcquisitionOperation(Model):
    ...
    :type reasons: list of :class:`AcquisitionOperationDisallowReason <extension-management.v5_1.models.AcquisitionOperationDisallowReason>`
    """
...
class AcquisitionOptions(Model):
    ...
    :type default_operation: :class:`AcquisitionOperation <extension-management.v5_1.models.AcquisitionOperation>`
    :param item_id: The item id that this options refer to
    :type item_id: str
    :param operations: Operations allowed for the ItemId in this target
    :type operations: list of :class:`AcquisitionOperation <extension-management.v5_1.models.AcquisitionOperation>`
    :param properties: Additional properties which can be added to the request.
    :type properties: :class:`object <extension-management.v5_1.models.object>`
...
class ExtensionDataCollection(Model):
    ...
    :type documents: list of :class:`object <extension-management.v5_1.models.object>`
...
class ExtensionDataCollectionQuery(Model):
    ...
    :type collections: list of :class:`ExtensionDataCollection <extension-management.v5_1.models.ExtensionDataCollection>`
    """
...
class ExtensionEventCallbackCollection(Model):
    ...
    :type post_disable: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    ...
    :type post_enable: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    ...
    :type post_install: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    ...
    :type post_uninstall: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    ...
    :type post_update: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    ...
    :type pre_install: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    ...
    :type version_check: :class:`ExtensionEventCallback <extension-management.v5_1.models.ExtensionEventCallback>`
    """
...
class ExtensionLicensing(Model):
    ...
    :type overrides: list of :class:`LicensingOverride <extension-management.v5_1.models.LicensingOverride>`
    """
...
class ExtensionManifest(Model):
    ...
    :type constraints: list of :class:`ContributionConstraint <extension-management.v5_1.models.ContributionConstraint>`
    :param contributions: List of contributions made by this extension
    :type contributions: list of :class:`Contribution <extension-management.v5_1.models.Contribution>`
    :param contribution_types: List of contribution types defined by this extension
    :type contribution_types: list of :class:`ContributionType <extension-management.v5_1.models.ContributionType>`
    ...
    :type event_callbacks: :class:`ExtensionEventCallbackCollection <extension-management.v5_1.models.ExtensionEventCallbackCollection>`
    ...
    :type licensing: :class:`ExtensionLicensing <extension-management.v5_1.models.ExtensionLicensing>`
...
class ExtensionRequest(Model):
    ...
    :type requested_by: :class:`IdentityRef <extension-management.v5_1.models.IdentityRef>`
    ...
    :type resolved_by: :class:`IdentityRef <extension-management.v5_1.models.IdentityRef>`
    """
...
class ExtensionVersion(Model):
    ...
    :type asset_uri: str
    :param badges:
    :type badges: list of :class:`ExtensionBadge <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.ExtensionBadge>`
    :param fallback_asset_uri:
    :type fallback_asset_uri: str
    :param files:
    :type files: list of :class:`ExtensionFile <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.ExtensionFile>`
    :param flags:
    :type flags: object
    :param last_updated:
...
class InstalledExtension(ExtensionManifest):
    ...
    :type files: list of :class:`ExtensionFile <extension-management.v5_1.models.ExtensionFile>`
    ...
    :type install_state: :class:`InstalledExtensionState <extension-management.v5_1.models.InstalledExtensionState>`
...
class InstalledExtensionQuery(Model):
    ...
    :param monikers:
    :type monikers: list of :class:`ExtensionIdentifier <extension-management.v5_1.models.ExtensionIdentifier>`
    """
...
class InstalledExtensionState(Model):
    ...
    :type installation_issues: list of :class:`InstalledExtensionStateIssue <extension-management.v5_1.models.InstalledExtensionStateIssue>`
...
class PublishedExtension(Model):
    ...
    :type installation_targets: list of :class:`InstallationTarget <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.InstallationTarget>`
    :param last_updated:
    :type last_updated: datetime
    ...
    :param publisher:
    :type publisher: :class:`PublisherFacts <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.PublisherFacts>`
    :param release_date: Date on which the extension first went public.
    :type release_date: datetime
    :param shared_with:
    :type shared_with: list of :class:`ExtensionShare <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.ExtensionShare>`
    :param short_description:
    :type short_description: str
    :param statistics:
    :type statistics: list of :class:`ExtensionStatistic <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.ExtensionStatistic>`
    :param tags:
    :type tags: list of str
    :param versions:
    :type versions: list of :class:`ExtensionVersion <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.ExtensionVersion>`
    """
...
class RequestedExtension(Model):
    ...
    :type extension_requests: list of :class:`ExtensionRequest <extension-management.v5_1.models.ExtensionRequest>`
...
class UserExtensionPolicy(Model):
    ...
    :type permissions: :class:`ExtensionPolicy <microsoft.-visual-studio.-services.-gallery.-web-api.v5_1.models.ExtensionPolicy>`
