...
class ExtensionManagementClient(VssClient):
    ...
    def update_installed_extension(self, extension):
        ...
        :param :class:`<InstalledExtension> <extension-management.v5_1.models.InstalledExtension>` extension:
        :rtype: :class:`<InstalledExtension> <extension-management.v5_1.models.InstalledExtension>`
        """
