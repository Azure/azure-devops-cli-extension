...
class MavenDistributionManagement(Model):
    ...
    :param repository:
    :type repository: :class:`MavenRepository <maven.v5_1.models.MavenRepository>`
    :param snapshot_repository:
    :type snapshot_repository: :class:`MavenSnapshotRepository <maven.v5_1.models.MavenSnapshotRepository>`
    """
...
class MavenPackage(Model):
    ...
    :type artifact_index: :class:`ReferenceLink <maven.v5_1.models.ReferenceLink>`
    :param artifact_metadata:
    :type artifact_metadata: :class:`ReferenceLink <maven.v5_1.models.ReferenceLink>`
    :param deleted_date:
    :type deleted_date: datetime
    :param files:
    :type files: :class:`ReferenceLinks <maven.v5_1.models.ReferenceLinks>`
    :param group_id:
    :type group_id: str
    :param pom:
    :type pom: :class:`MavenPomMetadata <maven.v5_1.models.MavenPomMetadata>`
    :param requested_file:
    :type requested_file: :class:`ReferenceLink <maven.v5_1.models.ReferenceLink>`
    :param snapshot_metadata:
    :type snapshot_metadata: :class:`ReferenceLink <maven.v5_1.models.ReferenceLink>`
    :param version:
    :type version: str
    :param versions:
    :type versions: :class:`ReferenceLinks <maven.v5_1.models.ReferenceLinks>`
    :param versions_index:
    :type versions_index: :class:`ReferenceLink <maven.v5_1.models.ReferenceLink>`
    """
...
class MavenPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <maven.v5_1.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MavenMinimalPackageDetails <maven.v5_1.models.MavenMinimalPackageDetails>`
    """
...
class MavenPomBuild(Model):
    ...
    :param plugins:
    :type plugins: list of :class:`Plugin <maven.v5_1.models.Plugin>`
    """
...
class MavenPomCi(Model):
    ...
    :param notifiers:
    :type notifiers: list of :class:`MavenPomCiNotifier <maven.v5_1.models.MavenPomCiNotifier>`
    :param system:
    :type system: str
    :param url:
    :type url: str
...
class MavenPomDependencyManagement(Model):
    ...
    :param dependencies:
    :type dependencies: list of :class:`MavenPomDependency <maven.v5_1.models.MavenPomDependency>`
    """
...
class MavenPomMetadata(MavenPomGav):
    ...
    :type version: str
    :param build:
    :type build: :class:`MavenPomBuild <maven.v5_1.models.MavenPomBuild>`
    :param ci_management:
    :type ci_management: :class:`MavenPomCi <maven.v5_1.models.MavenPomCi>`
    :param contributors:
    :type contributors: list of :class:`MavenPomPerson <maven.v5_1.models.MavenPomPerson>`
    :param dependencies:
    :type dependencies: list of :class:`MavenPomDependency <maven.v5_1.models.MavenPomDependency>`
    :param dependency_management:
    :type dependency_management: :class:`MavenPomDependencyManagement <maven.v5_1.models.MavenPomDependencyManagement>`
    :param description:
    :type description: str
    :param developers:
    :type developers: list of :class:`MavenPomPerson <maven.v5_1.models.MavenPomPerson>`
    :param distribution_management:
    :type distribution_management: :class:`MavenDistributionManagement <maven.v5_1.models.MavenDistributionManagement>`
    :param inception_year:
    :type inception_year: str
    :param issue_management:
    :type issue_management: :class:`MavenPomIssueManagement <maven.v5_1.models.MavenPomIssueManagement>`
    :param licenses:
    :type licenses: list of :class:`MavenPomLicense <maven.v5_1.models.MavenPomLicense>`
    :param mailing_lists:
    :type mailing_lists: list of :class:`MavenPomMailingList <maven.v5_1.models.MavenPomMailingList>`
    :param model_version:
    ...
    :type name: str
    :param organization:
    :type organization: :class:`MavenPomOrganization <maven.v5_1.models.MavenPomOrganization>`
    :param packaging:
    :type packaging: str
    :param parent:
    :type parent: :class:`MavenPomParent <maven.v5_1.models.MavenPomParent>`
    :param prerequisites:
    :type prerequisites: dict
    :param properties:
    :type properties: dict
    :param scm:
    :type scm: :class:`MavenPomScm <maven.v5_1.models.MavenPomScm>`
    :param url:
    :type url: str
    """
...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <maven.v5_1.models.ReferenceLinks>`
...
class Plugin(MavenPomGav):
    ...
    :type version: str
    :param configuration:
    :type configuration: :class:`PluginConfiguration <maven.v5_1.models.PluginConfiguration>`
    """
