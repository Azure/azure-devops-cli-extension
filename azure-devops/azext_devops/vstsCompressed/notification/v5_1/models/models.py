...
class BatchNotificationOperation(Model):
    ...
    :type notification_query_conditions: list of :class:`NotificationQueryCondition <notification.v5_1.models.NotificationQueryCondition>`
    """
...
class ExpressionFilterModel(Model):
    ...
    :type clauses: list of :class:`ExpressionFilterClause <notification.v5_1.models.ExpressionFilterClause>`
    :param groups: Grouping of clauses in the subscription
    :type groups: list of :class:`ExpressionFilterGroup <notification.v5_1.models.ExpressionFilterGroup>`
...
class INotificationDiagnosticLog(Model):
    ...
    :type log_type: str
    :param messages:
    :type messages: list of :class:`NotificationDiagnosticLogMessage <notification.v5_1.models.NotificationDiagnosticLogMessage>`
    :param properties:
...
class InputValuesQuery(Model):
    ...
    :type input_values: list of :class:`InputValues <microsoft.-visual-studio.-services.-web-api.v5_1.models.InputValues>`
...
class NotificationEventField(Model):
    ...
    :type field_type: :class:`NotificationEventFieldType <notification.v5_1.models.NotificationEventFieldType>`
...
class NotificationEventFieldType(Model):
    ...
    :type operator_constraints: list of :class:`OperatorConstraint <notification.v5_1.models.OperatorConstraint>`
    :param operators: Gets or sets the list of operators that this type supports.
    :type operators: list of :class:`NotificationEventFieldOperator <notification.v5_1.models.NotificationEventFieldOperator>`
    ...
    :type value: :class:`ValueDefinition <notification.v5_1.models.ValueDefinition>`
    """
...
class NotificationEventPublisher(Model):
    ...
    :type subscription_management_info: :class:`SubscriptionManagement <notification.v5_1.models.SubscriptionManagement>`
    :param url:
    :type url: str
    """
...
class NotificationEventType(Model):
    ...
    :param category:
    :type category: :class:`NotificationEventTypeCategory <notification.v5_1.models.NotificationEventTypeCategory>`
    ...
    :type event_publisher: :class:`NotificationEventPublisher <notification.v5_1.models.NotificationEventPublisher>`
    :param fields:
    :type fields: dict
    :param has_initiator:
    ...
    :type name: str
    :param roles:
    :type roles: list of :class:`NotificationEventRole <notification.v5_1.models.NotificationEventRole>`
...
class NotificationReason(Model):
    ...
    :type target_identities: list of :class:`IdentityRef <notification.v5_1.models.IdentityRef>`
    """
...
class NotificationStatistic(Model):
    ...
    :type type: object
    :param user:
    :type user: :class:`IdentityRef <notification.v5_1.models.IdentityRef>`
    """
...
class NotificationStatisticsQuery(Model):
    ...
    :param conditions:
    :type conditions: list of :class:`NotificationStatisticsQueryConditions <notification.v5_1.models.NotificationStatisticsQueryConditions>`
    """
...
class NotificationSubscription(Model):
    ...
    :type _links: :class:`ReferenceLinks <notification.v5_1.models.ReferenceLinks>`
    :param admin_settings: Admin-managed settings for the subscription. Only applies when the subscriber is a group.
    :type admin_settings: :class:`SubscriptionAdminSettings <notification.v5_1.models.SubscriptionAdminSettings>`
    :param channel: Channel for delivering notifications triggered by the subscription.
    :type channel: :class:`ISubscriptionChannel <notification.v5_1.models.ISubscriptionChannel>`
    ...
    :type diagnostics: :class:`SubscriptionDiagnostics <notification.v5_1.models.SubscriptionDiagnostics>`
    ...
    :type filter: :class:`ISubscriptionFilter <notification.v5_1.models.ISubscriptionFilter>`
    ...
    :type last_modified_by: :class:`IdentityRef <notification.v5_1.models.IdentityRef>`
    ...
    :type scope: :class:`SubscriptionScope <notification.v5_1.models.SubscriptionScope>`
    ...
    :type subscriber: :class:`IdentityRef <notification.v5_1.models.IdentityRef>`
    ...
    :type user_settings: :class:`SubscriptionUserSettings <notification.v5_1.models.SubscriptionUserSettings>`
    """
...
class NotificationSubscriptionTemplate(Model):
    ...
    :type notification_event_information: :class:`NotificationEventType <notification.v5_1.models.NotificationEventType>`
    :param type:
    :type type: object
    """
...
class SubscriptionDiagnostics(Model):
    ...
    :type delivery_results: :class:`SubscriptionTracing <notification.v5_1.models.SubscriptionTracing>`
    :param delivery_tracing:
    :type delivery_tracing: :class:`SubscriptionTracing <notification.v5_1.models.SubscriptionTracing>`
    :param evaluation_tracing:
    :type evaluation_tracing: :class:`SubscriptionTracing <notification.v5_1.models.SubscriptionTracing>`
    """
...
class SubscriptionEvaluationRequest(Model):
    ...
    :type subscription_create_parameters: :class:`NotificationSubscriptionCreateParameters <notification.v5_1.models.NotificationSubscriptionCreateParameters>`
    """
...
class SubscriptionEvaluationResult(Model):
    ...
    :type events: :class:`EventsEvaluationResult <notification.v5_1.models.EventsEvaluationResult>`
    ...
    :type notifications: :class:`NotificationsEvaluationResult <notification.v5_1.models.NotificationsEvaluationResult>`
    """
...
class SubscriptionQuery(Model):
    ...
    :type conditions: list of :class:`SubscriptionQueryCondition <notification.v5_1.models.SubscriptionQueryCondition>`
...
class UpdateSubscripitonDiagnosticsParameters(Model):
    ...
    :param delivery_results:
    :type delivery_results: :class:`UpdateSubscripitonTracingParameters <notification.v5_1.models.UpdateSubscripitonTracingParameters>`
    :param delivery_tracing:
    :type delivery_tracing: :class:`UpdateSubscripitonTracingParameters <notification.v5_1.models.UpdateSubscripitonTracingParameters>`
    :param evaluation_tracing:
    :type evaluation_tracing: :class:`UpdateSubscripitonTracingParameters <notification.v5_1.models.UpdateSubscripitonTracingParameters>`
    """
...
class ValueDefinition(Model):
    ...
    :type data_source: list of :class:`InputValue <notification.v5_1.models.InputValue>`
...
class VssNotificationEvent(Model):
    ...
    :type actors: list of :class:`EventActor <microsoft.-visual-studio.-services.-web-api.v5_1.models.EventActor>`
    ...
    :type scopes: list of :class:`EventScope <microsoft.-visual-studio.-services.-web-api.v5_1.models.EventScope>`
...
class FieldInputValues(InputValues):
    ...
    :type default_value: str
    :param error: Errors encountered while computing dynamic values.
    :type error: :class:`InputValuesError <notification.v5_1.models.InputValuesError>`
    :param input_id: The id of the input
    :type input_id: str
    :param is_disabled: Should this input be disabled
    :type is_disabled: bool
    ...
    :type is_read_only: bool
    :param possible_values: Possible values that this input can take
    :type possible_values: list of :class:`InputValue <notification.v5_1.models.InputValue>`
    :param operators:
    :type operators: str
    """
...
class FieldValuesQuery(InputValuesQuery):
    ...
    :type resource: object
    :param input_values:
    :type input_values: list of :class:`FieldInputValues <notification.v5_1.models.FieldInputValues>`
    :param scope:
    :type scope: str
    """
