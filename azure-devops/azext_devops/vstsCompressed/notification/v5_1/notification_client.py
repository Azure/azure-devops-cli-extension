...
class NotificationClient(VssClient):
    ...
    def get_subscription_diagnostics(self, subscription_id):
        ...
        :rtype: :class:`<SubscriptionDiagnostics> <notification.v5_1.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def update_subscription_diagnostics(self, update_parameters, subscription_id):
        ...
        [Preview API]
        :param :class:`<UpdateSubscripitonDiagnosticsParameters> <notification.v5_1.models.UpdateSubscripitonDiagnosticsParameters>` update_parameters:
        :param str subscription_id:
        :rtype: :class:`<SubscriptionDiagnostics> <notification.v5_1.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def publish_event(self, notification_event):
        ...
        :param :class:`<VssNotificationEvent> <notification.v5_1.models.VssNotificationEvent>` notification_event:
        :rtype: :class:`<VssNotificationEvent> <notification.v5_1.models.VssNotificationEvent>`
        """
    ...
    def get_event_type(self, event_type):
        ...
        :rtype: :class:`<NotificationEventType> <notification.v5_1.models.NotificationEventType>`
        """
        route_values = {}
    ...
    def get_settings(self):
        """GetSettings.
        [Preview API]
        :rtype: :class:`<NotificationAdminSettings> <notification.v5_1.models.NotificationAdminSettings>`
        """
        response = self._send(http_method='GET',
    ...
    def update_settings(self, update_parameters):
        """UpdateSettings.
        [Preview API]
        :param :class:`<NotificationAdminSettingsUpdateParameters> <notification.v5_1.models.NotificationAdminSettingsUpdateParameters>` update_parameters:
        :rtype: :class:`<NotificationAdminSettings> <notification.v5_1.models.NotificationAdminSettings>`
        """
    ...
    def get_subscriber(self, subscriber_id):
        ...
        :rtype: :class:`<NotificationSubscriber> <notification.v5_1.models.NotificationSubscriber>`
        """
        route_values = {}
    ...
    def update_subscriber(self, update_parameters, subscriber_id):
        """UpdateSubscriber.
        [Preview API]
        :param :class:`<NotificationSubscriberUpdateParameters> <notification.v5_1.models.NotificationSubscriberUpdateParameters>` update_parameters:
        :param str subscriber_id:
        :rtype: :class:`<NotificationSubscriber> <notification.v5_1.models.NotificationSubscriber>`
        """
        route_values = {}
    ...
    def query_subscriptions(self, subscription_query):
        ...
        :param :class:`<SubscriptionQuery> <notification.v5_1.models.SubscriptionQuery>` subscription_query:
    ...
    def create_subscription(self, create_parameters):
        ...
        :param :class:`<NotificationSubscriptionCreateParameters> <notification.v5_1.models.NotificationSubscriptionCreateParameters>` create_parameters:
        :rtype: :class:`<NotificationSubscription> <notification.v5_1.models.NotificationSubscription>`
        """
    ...
    def update_subscription(self, update_parameters, subscription_id):
        ...
        :param :class:`<NotificationSubscriptionUpdateParameters> <notification.v5_1.models.NotificationSubscriptionUpdateParameters>` update_parameters:
        :param str subscription_id:
        :rtype: :class:`<NotificationSubscription> <notification.v5_1.models.NotificationSubscription>`
        """
        route_values = {}
    ...
    def update_subscription_user_settings(self, user_settings, subscription_id, user_id):
        ...
        :param :class:`<SubscriptionUserSettings> <notification.v5_1.models.SubscriptionUserSettings>` user_settings:
        :param str subscription_id:
        :param str user_id: ID of the user
        :rtype: :class:`<SubscriptionUserSettings> <notification.v5_1.models.SubscriptionUserSettings>`
        """
        route_values = {}
        if subscription_id is not None:
            route_values['subscriptionId'] = self._serialize.url('subscription_id', subscription_id, 'str')
