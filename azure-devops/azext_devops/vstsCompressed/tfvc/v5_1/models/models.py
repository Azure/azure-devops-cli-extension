...
class Change(Model):
    ...
    :type new_content: :class:`ItemContent <tfvc.v5_1.models.ItemContent>`
...
class GitRepository(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <tfvc.v5_1.models.ReferenceLinks>`
    ...
    :type parent_repository: :class:`GitRepositoryRef <tfvc.v5_1.models.GitRepositoryRef>`
    :param project:
    :type project: :class:`TeamProjectReference <tfvc.v5_1.models.TeamProjectReference>`
    :param remote_url:
    :type remote_url: str
...
class GitRepositoryRef(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <tfvc.v5_1.models.TeamProjectCollectionReference>`
    :param id:
    :type id: str
    :param is_fork: True if the repository was created as a fork
    :type is_fork: bool
...
class ItemModel(Model):
    ...
    :type content_metadata: :class:`FileContentMetadata <tfvc.v5_1.models.FileContentMetadata>`
    :param is_folder:
    :type is_folder: bool
    :param is_sym_link:
...
class TfvcChange(Change):
    ...
    :type merge_sources: list of :class:`TfvcMergeSource <tfvc.v5_1.models.TfvcMergeSource>`
...
class TfvcChangesetRef(Model):
    ...
    :type author: :class:`IdentityRef <tfvc.v5_1.models.IdentityRef>`
    :param changeset_id: Id of the changeset.
    :type changeset_id: int
    :param checked_in_by: Alias or display name of user
    :type checked_in_by: :class:`IdentityRef <tfvc.v5_1.models.IdentityRef>`
...
class TfvcChangesetSearchCriteria(Model):
    ...
    :type item_path: str
    :param mappings:
    :type mappings: list of :class:`TfvcMappingFilter <tfvc.v5_1.models.TfvcMappingFilter>`
...
class TfvcItemRequestData(Model):
    ...
    :type item_descriptors: list of :class:`TfvcItemDescriptor <tfvc.v5_1.models.TfvcItemDescriptor>`
    """
...
class TfvcLabelRef(Model):
    ...
    :type name: str
    :param owner:
    :type owner: :class:`IdentityRef <tfvc.v5_1.models.IdentityRef>`
    :param url:
    :type url: str
    """
...
class TfvcPolicyOverrideInfo(Model):
    ...
    :type policy_failures: list of :class:`TfvcPolicyFailureInfo <tfvc.v5_1.models.TfvcPolicyFailureInfo>`
    """
...
class VstsInfo(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <tfvc.v5_1.models.TeamProjectCollectionReference>`
    :param repository:
    :type repository: :class:`GitRepository <tfvc.v5_1.models.GitRepository>`
    :param server_url:
    :type server_url: str
    """
...
class TfvcChangeset(TfvcChangesetRef):
    ...
    :type changes: list of :class:`TfvcChange <tfvc.v5_1.models.TfvcChange>`
    :param checkin_notes: Checkin Notes for the changeset.
    :type checkin_notes: list of :class:`CheckinNote <tfvc.v5_1.models.CheckinNote>`
    ...
    :type policy_override: :class:`TfvcPolicyOverrideInfo <tfvc.v5_1.models.TfvcPolicyOverrideInfo>`
    ...
    :type work_items: list of :class:`AssociatedWorkItem <tfvc.v5_1.models.AssociatedWorkItem>`
    """
...
class TfvcLabel(TfvcLabelRef):
    ...
    :type url: str
    :param items:
    :type items: list of :class:`TfvcItem <tfvc.v5_1.models.TfvcItem>`
    """
...
class TfvcShelveset(TfvcShelvesetRef):
    ...
    :type changes: list of :class:`TfvcChange <tfvc.v5_1.models.TfvcChange>`
    :param notes:
    :type notes: list of :class:`CheckinNote <tfvc.v5_1.models.CheckinNote>`
...
class TfvcBranch(TfvcBranchRef):
    ...
    :type children: list of :class:`TfvcBranch <tfvc.v5_1.models.TfvcBranch>`
    :param mappings: List of branch mappings.
    :type mappings: list of :class:`TfvcBranchMapping <tfvc.v5_1.models.TfvcBranchMapping>`
    :param parent: Path of the branch's parent.
    :type parent: :class:`TfvcShallowBranchRef <tfvc.v5_1.models.TfvcShallowBranchRef>`
    :param related_branches: List of paths of the related branches.
    :type related_branches: list of :class:`TfvcShallowBranchRef <tfvc.v5_1.models.TfvcShallowBranchRef>`
    """
