...
class Control(Model):
    ...
    :type contribution: :class:`WitContribution <work-item-tracking.v5_1.models.WitContribution>`
...
class CreateProcessRuleRequest(Model):
    ...
    :type actions: list of :class:`RuleAction <work-item-tracking.v5_1.models.RuleAction>`
    :param conditions: List of conditions when the rule should be triggered.
    :type conditions: list of :class:`RuleCondition <work-item-tracking.v5_1.models.RuleCondition>`
...
class FieldRuleModel(Model):
    ...
    :param actions:
    :type actions: list of :class:`RuleActionModel <work-item-tracking.v5_1.models.RuleActionModel>`
    :param conditions:
    :type conditions: list of :class:`RuleConditionModel <work-item-tracking.v5_1.models.RuleConditionModel>`
    :param friendly_name:
...
class FormLayout(Model):
    ...
    :type extensions: list of :class:`Extension <work-item-tracking.v5_1.models.Extension>`
    :param pages: Top level tabs of the layout.
    :type pages: list of :class:`Page <work-item-tracking.v5_1.models.Page>`
    :param system_controls: Headers controls of the layout.
    :type system_controls: list of :class:`Control <work-item-tracking.v5_1.models.Control>`
    """
...
class Group(Model):
    ...
    :type controls: list of :class:`Control <work-item-tracking.v5_1.models.Control>`
...
class Page(Model):
    ...
    :type sections: list of :class:`Section <work-item-tracking.v5_1.models.Section>`
...
class ProcessBehavior(Model):
    ...
    :type fields: list of :class:`ProcessBehaviorField <work-item-tracking.v5_1.models.ProcessBehaviorField>`
    :param inherits: Parent behavior reference.
    :type inherits: :class:`ProcessBehaviorReference <work-item-tracking.v5_1.models.ProcessBehaviorReference>`
...
class ProcessInfo(Model):
    ...
    :type projects: list of :class:`ProjectReference <work-item-tracking.v5_1.models.ProjectReference>`
...
class ProcessModel(Model):
    ...
    :type properties: :class:`ProcessProperties <work-item-tracking.v5_1.models.ProcessProperties>`
    :param reference_name: Reference name of the process
    :type reference_name: str
    :param type_id: The ID of the process
    :type type_id: str
...
class ProcessWorkItemType(Model):
    ...
    :param behaviors:
    :type behaviors: list of :class:`WorkItemTypeBehavior <work-item-tracking.v5_1.models.WorkItemTypeBehavior>`
    :param color: Color hexadecimal code to represent the work item type
    :type color: str
    ...
    :type is_disabled: bool
    :param layout:
    :type layout: :class:`FormLayout <work-item-tracking.v5_1.models.FormLayout>`
    :param name: Name of the work item type
    :type name: str
    :param reference_name: Reference name of work item type
    :type reference_name: str
    :param states:
    :type states: list of :class:`WorkItemStateResultModel <work-item-tracking.v5_1.models.WorkItemStateResultModel>`
...
class Section(Model):
    ...
    :type groups: list of :class:`Group <work-item-tracking.v5_1.models.Group>`
    :param id: The id for the layout node.
    :type id: str
    :param overridden: A value indicating whether this layout node has been overridden by a child layout.
    :type overridden: bool
...
class WorkItemBehavior(Model):
    ...
    :type description: str
    :param fields:
    :type fields: list of :class:`WorkItemBehaviorField <work-item-tracking.v5_1.models.WorkItemBehaviorField>`
    :param id:
    :type id: str
    :param inherits:
    :type inherits: :class:`WorkItemBehaviorReference <work-item-tracking.v5_1.models.WorkItemBehaviorReference>`
    :param name:
    :type name: str
    :param overriden:
    :type overriden: bool
...
class WorkItemTypeBehavior(Model):
    ...
    :type behavior: :class:`WorkItemBehaviorReference <work-item-tracking.v5_1.models.WorkItemBehaviorReference>`
