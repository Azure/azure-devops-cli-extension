...
class WorkItemTrackingClient(VssClient):
    ...
    def create_process_behavior(self, behavior, process_id):
        ...
        :param :class:`<ProcessBehaviorCreateRequest> <work-item-tracking.v5_1.models.ProcessBehaviorCreateRequest>` behavior:
        :param str process_id: The ID of the process
        :rtype: :class:`<ProcessBehavior> <work-item-tracking.v5_1.models.ProcessBehavior>`
        """
        route_values = {}
    ...
    def update_process_behavior(self, behavior_data, process_id, behavior_ref_name):
        ...
        :param :class:`<ProcessBehaviorUpdateRequest> <work-item-tracking.v5_1.models.ProcessBehaviorUpdateRequest>` behavior_data:
        :param str process_id: The ID of the process
        :param str behavior_ref_name: The reference name of the behavior
        :rtype: :class:`<ProcessBehavior> <work-item-tracking.v5_1.models.ProcessBehavior>`
        """
    ...
    def create_control_in_group(self, control, process_id, wit_ref_name, group_id):
        ...
        :param :class:`<Control> <work-item-tracking.v5_1.models.Control>` control: The control.
        :param str process_id: The ID of the process.
        ...
        :rtype: :class:`<Control> <work-item-tracking.v5_1.models.Control>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_control(self, control, process_id, wit_ref_name, group_id, control_id):
        ...
        :param :class:`<Control> <work-item-tracking.v5_1.models.Control>` control: The updated control.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str group_id: The ID of the group.
        :param str control_id: The ID of the control.
    ...
    def add_field_to_work_item_type(self, field, process_id, wit_ref_name):
        ...
        :param :class:`<AddProcessWorkItemTypeFieldRequest> <work-item-tracking.v5_1.models.AddProcessWorkItemTypeFieldRequest>` field:
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<ProcessWorkItemTypeField> <work-item-tracking.v5_1.models.ProcessWorkItemTypeField>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_work_item_type_field(self, field, process_id, wit_ref_name, field_ref_name):
        ...
        :param :class:`<UpdateProcessWorkItemTypeFieldRequest> <work-item-tracking.v5_1.models.UpdateProcessWorkItemTypeFieldRequest>` field:
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str field_ref_name: The reference name of the field.
        :rtype: :class:`<ProcessWorkItemTypeField> <work-item-tracking.v5_1.models.ProcessWorkItemTypeField>`
    ...
    def add_group(self, group, process_id, wit_ref_name, page_id, section_id):
        ...
        :param :class:`<Group> <work-item-tracking.v5_1.models.Group>` group: The group.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str page_id: The ID of the page to add the group to.
        :param str section_id: The ID of the section to add the group to.
        :rtype: :class:`<Group> <work-item-tracking.v5_1.models.Group>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def move_group_to_page(self, group, process_id, wit_ref_name, page_id, section_id, group_id, remove_from_page_id, remove_from_section_id):
        ...
        :param :class:`<Group> <work-item-tracking.v5_1.models.Group>` group: The updated group.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
    ...
    def get_form_layout(self, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<FormLayout> <work-item-tracking.v5_1.models.FormLayout>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_list(self, picklist):
        ...
        :param :class:`<PickList> <work-item-tracking.v5_1.models.PickList>` picklist: Picklist
        :rtype: :class:`<PickList> <work-item-tracking.v5_1.models.PickList>`
        """
    ...
    def update_list(self, picklist, list_id):
        ...
        :param :class:`<PickList> <work-item-tracking.v5_1.models.PickList>` picklist:
        :param str list_id: The ID of the list
        :rtype: :class:`<PickList> <work-item-tracking.v5_1.models.PickList>`
        """
        route_values = {}
    ...
    def add_page(self, page, process_id, wit_ref_name):
        ...
        :param :class:`<Page> <work-item-tracking.v5_1.models.Page>` page: The page.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<Page> <work-item-tracking.v5_1.models.Page>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_new_process(self, create_request):
        ...
        :param :class:`<CreateProcessModel> <work-item-tracking.v5_1.models.CreateProcessModel>` create_request: CreateProcessModel.
        :rtype: :class:`<ProcessInfo> <work-item-tracking.v5_1.models.ProcessInfo>`
        """
    ...
    def edit_process(self, update_request, process_type_id):
        ...
        :param :class:`<UpdateProcessModel> <work-item-tracking.v5_1.models.UpdateProcessModel>` update_request:
        :param str process_type_id:
        :rtype: :class:`<ProcessInfo> <work-item-tracking.v5_1.models.ProcessInfo>`
        """
        route_values = {}
    ...
    def add_process_work_item_type_rule(self, process_rule_create, process_id, wit_ref_name):
        ...
        :param :class:`<CreateProcessRuleRequest> <work-item-tracking.v5_1.models.CreateProcessRuleRequest>` process_rule_create:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<ProcessRule> <work-item-tracking.v5_1.models.ProcessRule>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_process_work_item_type_rule(self, process_rule, process_id, wit_ref_name, rule_id):
        ...
        :param :class:`<UpdateProcessRuleRequest> <work-item-tracking.v5_1.models.UpdateProcessRuleRequest>` process_rule:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str rule_id: The ID of the rule
        :rtype: :class:`<ProcessRule> <work-item-tracking.v5_1.models.ProcessRule>`
    ...
    def create_state_definition(self, state_model, process_id, wit_ref_name):
        ...
        :param :class:`<WorkItemStateInputModel> <work-item-tracking.v5_1.models.WorkItemStateInputModel>` state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<WorkItemStateResultModel> <work-item-tracking.v5_1.models.WorkItemStateResultModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def hide_state_definition(self, hide_state_model, process_id, wit_ref_name, state_id):
        ...
        :param :class:`<HideStateModel> <work-item-tracking.v5_1.models.HideStateModel>` hide_state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str state_id: The ID of the state
        :rtype: :class:`<WorkItemStateResultModel> <work-item-tracking.v5_1.models.WorkItemStateResultModel>`
    ...
    def create_process_work_item_type(self, work_item_type, process_id):
        ...
        :param :class:`<CreateProcessWorkItemTypeRequest> <work-item-tracking.v5_1.models.CreateProcessWorkItemTypeRequest>` work_item_type:
        :param str process_id: The ID of the process on which to create work item type.
        :rtype: :class:`<ProcessWorkItemType> <work-item-tracking.v5_1.models.ProcessWorkItemType>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_process_work_item_type(self, work_item_type_update, process_id, wit_ref_name):
        ...
        :param :class:`<UpdateProcessWorkItemTypeRequest> <work-item-tracking.v5_1.models.UpdateProcessWorkItemTypeRequest>` work_item_type_update:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<ProcessWorkItemType> <work-item-tracking.v5_1.models.ProcessWorkItemType>`
        """
    ...
    def add_behavior_to_work_item_type(self, behavior, process_id, wit_ref_name_for_behaviors):
        ...
        :param :class:`<WorkItemTypeBehavior> <work-item-tracking.v5_1.models.WorkItemTypeBehavior>` behavior:
        :param str process_id: The ID of the process
        :param str wit_ref_name_for_behaviors: Work item type reference name for the behavior
        :rtype: :class:`<WorkItemTypeBehavior> <work-item-tracking.v5_1.models.WorkItemTypeBehavior>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
