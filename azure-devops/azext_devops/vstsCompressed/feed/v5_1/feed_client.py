...
class FeedClient(VssClient):
    ...
    def get_feed_change(self, feed_id):
        ...
        :param str feed_id: Name or ID of the feed.
        :rtype: :class:`<FeedChange> <feed.v5_1.models.FeedChange>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def get_feed_changes(self, include_deleted=None, continuation_token=None, batch_size=None):
        ...
        :rtype: :class:`<FeedChangesResponse> <feed.v5_1.models.FeedChangesResponse>`
        """
        query_parameters = {}
    ...
    def create_feed(self, feed):
        ...
        :param :class:`<Feed> <feed.v5_1.models.Feed>` feed: A JSON object containing both required and optional attributes for the feed. Name is the only required value.
        :rtype: :class:`<Feed> <feed.v5_1.models.Feed>`
        """
    ...
    def update_feed(self, feed, feed_id):
        ...
        :param :class:`<FeedUpdate> <feed.v5_1.models.FeedUpdate>` feed: A JSON object containing the feed settings to be updated.
        :param str feed_id: Name or Id of the feed.
        :rtype: :class:`<Feed> <feed.v5_1.models.Feed>`
        """
        route_values = {}
    ...
    def get_package_changes(self, feed_id, continuation_token=None, batch_size=None):
        ...
        :param long continuation_token: A continuation token which acts as a bookmark to a previously retrieved change. This token allows the user to continue retrieving changes in batches, picking up where the previous batch left off. If specified, all the changes that occur strictly after the token will be returned. If not specified or 0, iteration will start with the first change.
        :param int batch_size: Number of package changes to fetch. The default value is 1000. The maximum value is 2000.
        :rtype: :class:`<PackageChangesResponse> <feed.v5_1.models.PackageChangesResponse>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def query_package_metrics(self, package_id_query, feed_id):
        """QueryPackageMetrics.
        [Preview API]
        :param :class:`<PackageMetricsQuery> <feed.v5_1.models.PackageMetricsQuery>` package_id_query:
        :param str feed_id:
    ...
    def get_package(self, feed_id, package_id, include_all_versions=None, include_urls=None, is_listed=None, is_release=None, include_deleted=None, include_description=None):
        ...
        :rtype: :class:`<Package> <feed.v5_1.models.Package>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def get_package_version_provenance(self, feed_id, package_id, package_version_id):
        ...
        :rtype: :class:`<PackageVersionProvenance> <feed.v5_1.models.PackageVersionProvenance>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def get_recycle_bin_package_version(self, feed_id, package_id, package_version_id, include_urls=None):
        ...
        :param bool include_urls: True to return REST Urls with the response.  Default is True.
        :rtype: :class:`<RecycleBinPackageVersion> <feed.v5_1.models.RecycleBinPackageVersion>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def get_feed_retention_policies(self, feed_id):
        ...
        :param str feed_id: Name or ID of the feed.
        :rtype: :class:`<FeedRetentionPolicy> <feed.v5_1.models.FeedRetentionPolicy>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def set_feed_retention_policies(self, policy, feed_id):
        ...
        :param :class:`<FeedRetentionPolicy> <feed.v5_1.models.FeedRetentionPolicy>` policy: Feed retention policy.
        :param str feed_id: Name or ID of the feed.
        :rtype: :class:`<FeedRetentionPolicy> <feed.v5_1.models.FeedRetentionPolicy>`
        """
        route_values = {}
    ...
    def query_package_version_metrics(self, package_version_id_query, feed_id, package_id):
        ...
        [Preview API]
        :param :class:`<PackageVersionMetricsQuery> <feed.v5_1.models.PackageVersionMetricsQuery>` package_version_id_query:
        :param str feed_id:
    ...
    def get_package_version(self, feed_id, package_id, package_version_id, include_urls=None, is_listed=None, is_deleted=None):
        ...
        :rtype: :class:`<PackageVersion> <feed.v5_1.models.PackageVersion>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def create_feed_view(self, view, feed_id):
        ...
        :param :class:`<FeedView> <feed.v5_1.models.FeedView>` view: View to be created.
        :param str feed_id: Name or Id of the feed.
        :rtype: :class:`<FeedView> <feed.v5_1.models.FeedView>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def update_feed_view(self, view, feed_id, view_id):
        ...
        :param :class:`<FeedView> <feed.v5_1.models.FeedView>` view: New settings to apply to the specified view.
        :param str feed_id: Name or Id of the feed.
        :param str view_id: Name or Id of the view.
        :rtype: :class:`<FeedView> <feed.v5_1.models.FeedView>`
        """
