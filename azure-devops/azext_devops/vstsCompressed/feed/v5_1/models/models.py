...
class FeedBatchData(Model):
    ...
    :param data:
    :type data: :class:`FeedBatchOperationData <packaging.v5_1.models.FeedBatchOperationData>`
    :param operation:
...
class FeedChange(Model):
    ...
    :type feed: :class:`Feed <packaging.v5_1.models.Feed>`
...
class FeedChangesResponse(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <packaging.v5_1.models.ReferenceLinks>`
    ...
    :type feed_changes: list of :class:`FeedChange <packaging.v5_1.models.FeedChange>`
...
class FeedCore(Model):
    ...
    :type upstream_sources: list of :class:`UpstreamSource <packaging.v5_1.models.UpstreamSource>`
    :param view: Definition of the view.
    :type view: :class:`FeedView <packaging.v5_1.models.FeedView>`
...
class FeedPermission(Model):
    ...
    :type identity_descriptor: :class:`str <packaging.v5_1.models.str>`
...
class MinimalPackageVersion(Model):
    ...
    :type views: list of :class:`FeedView <packaging.v5_1.models.FeedView>`
    """
...
class Package(Model):
    ...
    :type versions: list of :class:`MinimalPackageVersion <packaging.v5_1.models.MinimalPackageVersion>`
    """
...
class PackageChange(Model):
    ...
    :type package: :class:`Package <packaging.v5_1.models.Package>`
    :param package_version_change: Change that was performed on a package version.
    :type package_version_change: :class:`PackageVersionChange <packaging.v5_1.models.PackageVersionChange>`
    """
...
class PackageChangesResponse(Model):
    ...
    :type package_changes: list of :class:`PackageChange <packaging.v5_1.models.PackageChange>`
    """
...
class PackageFile(Model):
    ...
    :type children: list of :class:`PackageFile <packaging.v5_1.models.PackageFile>`
    :param name: File name.
    :type name: str
    :param protocol_metadata: Extended data unique to a specific package type.
    :type protocol_metadata: :class:`ProtocolMetadata <packaging.v5_1.models.ProtocolMetadata>`
    """
...
class PackageVersion(MinimalPackageVersion):
    ...
    :type dependencies: list of :class:`PackageDependency <packaging.v5_1.models.PackageDependency>`
    ...
    :type files: list of :class:`PackageFile <packaging.v5_1.models.PackageFile>`
    :param other_versions: Other versions of this package.
    :type other_versions: list of :class:`MinimalPackageVersion <packaging.v5_1.models.MinimalPackageVersion>`
    ...
    :type source_chain: list of :class:`UpstreamSource <packaging.v5_1.models.UpstreamSource>`
...
class PackageVersionChange(Model):
    ...
    :type package_version: :class:`PackageVersion <packaging.v5_1.models.PackageVersion>`
    """
...
class PackageVersionProvenance(Model):
    ...
    :type provenance: :class:`Provenance <packaging.v5_1.models.Provenance>`
    """
...
class Feed(FeedCore):
    ...
    :type permissions: list of :class:`FeedPermission <packaging.v5_1.models.FeedPermission>`
