...
class AccessTokenResult(Model):
    ...
    :param access_token:
    :type access_token: :class:`JsonWebToken <microsoft.-visual-studio.-services.-web-api.v5_1.models.JsonWebToken>`
    ...
    :type has_error: bool
    :param refresh_token:
    :type refresh_token: :class:`RefreshTokenGrant <microsoft.-visual-studio.-services.-web-api.v5_1.models.RefreshTokenGrant>`
    :param token_type:
    :type token_type: str
    :param valid_to:
...
class ChangedIdentities(Model):
    ...
    :type identities: list of :class:`Identity <identities.v5_1.models.Identity>`
    :param more_data: More data available, set to true if pagesize is specified.
    :type more_data: bool
    :param sequence_context: Last Identity SequenceId
    :type sequence_context: :class:`ChangedIdentitiesContext <identities.v5_1.models.ChangedIdentitiesContext>`
    """
...
class GroupMembership(Model):
    ...
    :type active: bool
    :param descriptor:
    :type descriptor: :class:`str <identities.v5_1.models.str>`
    :param id:
    :type id: str
    :param queried_id:
    :type queried_id: str
...
class IdentityBase(Model):
    ...
    :param member_of:
    :type member_of: list of :class:`str <identities.v5_1.models.str>`
    :param members:
    :type members: list of :class:`str <identities.v5_1.models.str>`
    :param meta_type_id:
    :type meta_type_id: int
    :param properties:
    :type properties: :class:`object <identities.v5_1.models.object>`
    ...
    :type subject_descriptor: :class:`str <identities.v5_1.models.str>`
...
class IdentityBatchInfo(Model):
    ...
    :param descriptors:
    :type descriptors: list of :class:`str <identities.v5_1.models.str>`
    :param identity_ids:
    ...
    :type subject_descriptors: list of :class:`str <identities.v5_1.models.str>`
    """
...
class IdentityScope(Model):
    ...
    :type administrators: :class:`str <identities.v5_1.models.str>`
    :param id:
    :type id: str
    :param is_active:
    :type is_active: bool
...
class IdentitySelf(Model):
    ...
    :type tenants: list of :class:`TenantInfo <identities.v5_1.models.TenantInfo>`
    """
...
class IdentitySnapshot(Model):
    ...
    :param groups:
    :type groups: list of :class:`Identity <identities.v5_1.models.Identity>`
    :param identity_ids:
    :type identity_ids: list of str
    :param memberships:
    :type memberships: list of :class:`GroupMembership <identities.v5_1.models.GroupMembership>`
    :param scope_id:
    :type scope_id: str
    :param scopes:
    :type scopes: list of :class:`IdentityScope <identities.v5_1.models.IdentityScope>`
    """
...
class RefreshTokenGrant(AuthorizationGrant):
    ...
    :type grant_type: object
    :param jwt:
    :type jwt: :class:`JsonWebToken <microsoft.-visual-studio.-services.-web-api.v5_1.models.JsonWebToken>`
    """
