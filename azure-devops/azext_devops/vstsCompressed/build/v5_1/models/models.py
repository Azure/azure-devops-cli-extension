...
class AgentPoolQueue(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <build.v5_1.models.ReferenceLinks>`
    :param id: The ID of the queue.
    :type id: int
    :param name: The name of the queue.
    :type name: str
    :param pool: The pool used by this queue.
    :type pool: :class:`TaskAgentPoolReference <build.v5_1.models.TaskAgentPoolReference>`
...
class AggregatedResultsAnalysis(Model):
    ...
    :type previous_context: :class:`TestResultsContext <microsoft.-team-foundation.-test-management.-web-api.v5_1.models.TestResultsContext>`
    :param results_by_outcome:
    :type results_by_outcome: dict
    :param results_difference:
    :type results_difference: :class:`AggregatedResultsDifference <microsoft.-team-foundation.-test-management.-web-api.v5_1.models.AggregatedResultsDifference>`
...
class Build(Model):
    ...
    :type controller: :class:`BuildController <build.v5_1.models.BuildController>`
    :param definition: The definition associated with the build.
    :type definition: :class:`DefinitionReference <build.v5_1.models.DefinitionReference>`
    ...
    :type deleted_by: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
    ...
    :type demands: list of :class:`object <build.v5_1.models.object>`
    ...
    :type last_changed_by: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
    ...
    :type logs: :class:`BuildLogReference <build.v5_1.models.BuildLogReference>`
    :param orchestration_plan: The orchestration plan for the build.
    :type orchestration_plan: :class:`TaskOrchestrationPlanReference <build.v5_1.models.TaskOrchestrationPlanReference>`
    :param parameters: The parameters for the build.
    :type parameters: str
    :param plans: Orchestration plans associated with the build (build, cleanup)
    :type plans: list of :class:`TaskOrchestrationPlanReference <build.v5_1.models.TaskOrchestrationPlanReference>`
    :param priority: The build's priority.
    :type priority: object
    :param project: The team project.
    :type project: :class:`TeamProjectReference <build.v5_1.models.TeamProjectReference>`
    :param properties:
    :type properties: :class:`object <build.v5_1.models.object>`
    ...
    :type queue: :class:`AgentPoolQueue <build.v5_1.models.AgentPoolQueue>`
    ...
    :type repository: :class:`BuildRepository <build.v5_1.models.BuildRepository>`
    :param requested_by: The identity that queued the build.
    :type requested_by: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
    :param requested_for: The identity on whose behalf the build was queued.
    :type requested_for: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
    ...
    :type triggered_by_build: :class:`Build <build.v5_1.models.Build>`
    ...
    :type validation_results: list of :class:`BuildRequestValidationResult <build.v5_1.models.BuildRequestValidationResult>`
    """
...
class BuildArtifact(Model):
    ...
    :type resource: :class:`ArtifactResource <build.v5_1.models.ArtifactResource>`
    """
...
class BuildDefinitionRevision(Model):
    ...
    :type changed_by: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
...
class BuildDefinitionStep(Model):
    ...
    :type task: :class:`TaskDefinitionReference <build.v5_1.models.TaskDefinitionReference>`
...
class BuildDefinitionTemplate(Model):
    ...
    :type template: :class:`BuildDefinition <build.v5_1.models.BuildDefinition>`
    """
...
class BuildDefinitionTemplate3_2(Model):
    ...
    :type name: str
    :param template:
    :type template: :class:`BuildDefinition3_2 <build.v5_1.models.BuildDefinition3_2>`
    """
...
class BuildOption(Model):
    ...
    :type definition: :class:`BuildOptionDefinitionReference <build.v5_1.models.BuildOptionDefinitionReference>`
...
class BuildSettings(Model):
    ...
    :type default_retention_policy: :class:`RetentionPolicy <build.v5_1.models.RetentionPolicy>`
    :param maximum_retention_policy: The maximum retention policy.
    :type maximum_retention_policy: :class:`RetentionPolicy <build.v5_1.models.RetentionPolicy>`
    """
...
class Change(Model):
    ...
    :type author: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
...
class Folder(Model):
    ...
    :type created_by: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
...
class ProcessParameters(Model):
    ...
    :type data_source_bindings: list of :class:`DataSourceBindingBase <microsoft.-team-foundation.-distributed-task.-common.-contracts.v5_1.models.DataSourceBindingBase>`
    :param inputs:
    :type inputs: list of :class:`TaskInputDefinitionBase <microsoft.-team-foundation.-distributed-task.-common.-contracts.v5_1.models.TaskInputDefinitionBase>`
    :param source_definitions:
    :type source_definitions: list of :class:`TaskSourceDefinitionBase <microsoft.-team-foundation.-distributed-task.-common.-contracts.v5_1.models.TaskSourceDefinitionBase>`
    """
...
class SourceProviderAttributes(Model):
    ...
    :type supported_triggers: list of :class:`SupportedTrigger <build.v5_1.models.SupportedTrigger>`
    """
...
class SourceRepositories(Model):
    ...
    :type repositories: list of :class:`SourceRepository <build.v5_1.models.SourceRepository>`
...
class TestResultsContext(Model):
    ...
    :param build:
    :type build: :class:`BuildReference <microsoft.-team-foundation.-test-management.-web-api.v5_1.models.BuildReference>`
    :param context_type:
    :type context_type: object
    :param release:
    :type release: :class:`ReleaseReference <microsoft.-team-foundation.-test-management.-web-api.v5_1.models.ReleaseReference>`
    """
...
class TimelineRecord(Model):
    ...
    :type details: :class:`TimelineReference <build.v5_1.models.TimelineReference>`
    ...
    :type identifier: str
    :param issues:
    :type issues: list of :class:`Issue <build.v5_1.models.Issue>`
    ...
    :type log: :class:`BuildLogReference <build.v5_1.models.BuildLogReference>`
    :param name: The name.
    :type name: str
    ...
    :type previous_attempts: list of :class:`TimelineAttempt <build.v5_1.models.TimelineAttempt>`
    :param result: The result.
    :type result: object
    ...
    :type task: :class:`TaskReference <build.v5_1.models.TaskReference>`
...
class BuildDefinitionReference(DefinitionReference):
    ...
    :type authored_by: :class:`IdentityRef <build.v5_1.models.IdentityRef>`
    :param draft_of: A reference to the definition that this definition is a draft of, if this is a draft definition.
    :type draft_of: :class:`DefinitionReference <build.v5_1.models.DefinitionReference>`
    :param drafts: The list of drafts associated with this definition, if this is not a draft definition.
    :type drafts: list of :class:`DefinitionReference <build.v5_1.models.DefinitionReference>`
    :param latest_build:
    :type latest_build: :class:`Build <build.v5_1.models.Build>`
    :param latest_completed_build:
    :type latest_completed_build: :class:`Build <build.v5_1.models.Build>`
    :param metrics:
    :type metrics: list of :class:`BuildMetric <build.v5_1.models.BuildMetric>`
...
class BuildOptionDefinition(BuildOptionDefinitionReference):
    ...
    :type groups: list of :class:`BuildOptionGroupDefinition <build.v5_1.models.BuildOptionGroupDefinition>`
    :param inputs: The list of inputs defined for the build option.
    :type inputs: list of :class:`BuildOptionInputDefinition <build.v5_1.models.BuildOptionInputDefinition>`
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <build.v5_1.models.TimelineRecord>`
    """
...
class BuildDefinition(BuildDefinitionReference):
    ...
    :param options:
    :type options: list of :class:`BuildOption <build.v5_1.models.BuildOption>`
    :param process: The build process.
    :type process: :class:`object <build.v5_1.models.object>`
    :param process_parameters: The process parameters for this definition.
    :type process_parameters: :class:`ProcessParameters <build.v5_1.models.ProcessParameters>`
    :param properties:
    :type properties: :class:`object <build.v5_1.models.object>`
    :param repository: The repository.
    :type repository: :class:`BuildRepository <build.v5_1.models.BuildRepository>`
    :param retention_rules:
    :type retention_rules: list of :class:`RetentionPolicy <build.v5_1.models.RetentionPolicy>`
    :param tags:
    :type tags: list of str
    :param triggers:
    :type triggers: list of :class:`object <build.v5_1.models.object>`
    :param variable_groups:
    :type variable_groups: list of :class:`VariableGroup <build.v5_1.models.VariableGroup>`
    :param variables:
    :type variables: dict
    """
...
class BuildDefinition3_2(BuildDefinitionReference3_2):
    ...
    :type badge_enabled: bool
    :param build:
    :type build: list of :class:`BuildDefinitionStep <build.v5_1.models.BuildDefinitionStep>`
    :param build_number_format: The build number format
    :type build_number_format: str
