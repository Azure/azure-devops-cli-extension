...
class BuildClient(VssClient):
    ...
    def create_artifact(self, artifact, project, build_id):
        ...
        :param :class:`<BuildArtifact> <build.v5_1.models.BuildArtifact>` artifact: The artifact.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :rtype: :class:`<BuildArtifact> <build.v5_1.models.BuildArtifact>`
        """
        route_values = {}
    ...
    def get_build_badge(self, project, repo_type, repo_id=None, branch_name=None):
        ...
        :rtype: :class:`<BuildBadge> <build.v5_1.models.BuildBadge>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_build(self, build, project, build_id, retry=None):
        ...
        :param :class:`<Build> <build.v5_1.models.Build>` build: The build.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :param bool retry:
        :rtype: :class:`<Build> <build.v5_1.models.Build>`
    ...
    def get_build_controller(self, controller_id):
        ...
        :rtype: :class:`<BuildController> <build.v5_1.models.BuildController>`
        """
        route_values = {}
    ...
    def create_definition(self, definition, project, definition_to_clone_id=None, definition_to_clone_revision=None):
        ...
        :param :class:`<BuildDefinition> <build.v5_1.models.BuildDefinition>` definition: The definition.
        :param str project: Project ID or project name
        :param int definition_to_clone_id:
        :param int definition_to_clone_revision:
        :rtype: :class:`<BuildDefinition> <build.v5_1.models.BuildDefinition>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_definition(self, definition, project, definition_id, secrets_source_definition_id=None, secrets_source_definition_revision=None):
        ...
        :param :class:`<BuildDefinition> <build.v5_1.models.BuildDefinition>` definition: The new version of the defintion.
        :param str project: Project ID or project name
        :param int definition_id: The ID of the definition.
    ...
    def create_folder(self, folder, project, path):
        ...
        :param :class:`<Folder> <build.v5_1.models.Folder>` folder: The folder.
        :param str project: Project ID or project name
        :param str path: The full path of the folder.
        :rtype: :class:`<Folder> <build.v5_1.models.Folder>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_folder(self, folder, project, path):
        ...
        :param :class:`<Folder> <build.v5_1.models.Folder>` folder: The new version of the folder.
        :param str project: Project ID or project name
        :param str path: The full path to the folder.
        :rtype: :class:`<Folder> <build.v5_1.models.Folder>`
        """
    ...
    def get_build_properties(self, project, build_id, filter=None):
        ...
        :rtype: :class:`<object> <build.v5_1.models.object>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_build_properties(self, document, project, build_id):
        ...
        :param :class:`<[JsonPatchOperation]> <build.v5_1.models.[JsonPatchOperation]>` document: A json-patch document describing the properties to update.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :rtype: :class:`<object> <build.v5_1.models.object>`
        """
    ...
    def get_pull_request(self, project, provider_name, pull_request_id, repository_id=None, service_endpoint_id=None):
        ...
        :param str service_endpoint_id: If specified, the ID of the service endpoint to query. Can only be omitted for providers that do not use service endpoints, e.g. TFVC or TFGit.
        :rtype: :class:`<PullRequest> <build.v5_1.models.PullRequest>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_build_report(self, project, build_id, type=None):
        ...
        :param int build_id: The ID of the build.
        :param str type:
        :rtype: :class:`<BuildReportMetadata> <build.v5_1.models.BuildReportMetadata>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def list_repositories(self, project, provider_name, service_endpoint_id=None, repository=None, result_set=None, page_results=None, continuation_token=None):
        ...
        :rtype: :class:`<SourceRepositories> <build.v5_1.models.SourceRepositories>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_resource_usage(self):
        ...
        :rtype: :class:`<BuildResourceUsage> <build.v5_1.models.BuildResourceUsage>`
        """
        response = self._send(http_method='GET',
    ...
    def get_build_settings(self, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<BuildSettings> <build.v5_1.models.BuildSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_build_settings(self, settings, project=None):
        ...
        :param :class:`<BuildSettings> <build.v5_1.models.BuildSettings>` settings: The new settings.
        :param str project: Project ID or project name
        :rtype: :class:`<BuildSettings> <build.v5_1.models.BuildSettings>`
        """
        route_values = {}
    ...
    def get_template(self, project, template_id):
        ...
        :rtype: :class:`<BuildDefinitionTemplate> <build.v5_1.models.BuildDefinitionTemplate>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def save_template(self, template, project, template_id):
        ...
        :param :class:`<BuildDefinitionTemplate> <build.v5_1.models.BuildDefinitionTemplate>` template: The new version of the template.
        :param str project: Project ID or project name
        :param str template_id: The ID of the template.
        :rtype: :class:`<BuildDefinitionTemplate> <build.v5_1.models.BuildDefinitionTemplate>`
        """
    ...
    def get_build_timeline(self, project, build_id, timeline_id=None, change_id=None, plan_id=None):
        ...
        :param int change_id:
        :param str plan_id:
        :rtype: :class:`<Timeline> <build.v5_1.models.Timeline>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
