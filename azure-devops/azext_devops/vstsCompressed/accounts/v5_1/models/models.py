...
class Account(Model):
    ...
    :type properties: :class:`object <accounts.v5_1.models.object>`
...
class AccountCreateInfoInternal(Model):
    ...
    :param preferences:
    :type preferences: :class:`AccountPreferencesInternal <accounts.v5_1.models.AccountPreferencesInternal>`
    :param properties:
    :type properties: :class:`object <accounts.v5_1.models.object>`
