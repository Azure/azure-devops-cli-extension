...
class UPackPackagingClient(VssClient):
    ...
    def add_package(self, metadata, feed_id, package_name, package_version):
        """AddPackage.
        [Preview API]
        :param :class:`<UPackPackagePushMetadata> <uPack-packaging.v5_1.models.UPackPackagePushMetadata>` metadata:
        :param str feed_id:
    ...
    def get_package_metadata(self, feed_id, package_name, package_version, intent=None):
        ...
        :param str package_version:
        :param str intent:
        :rtype: :class:`<UPackPackageMetadata> <uPack-packaging.v5_1.models.UPackPackageMetadata>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def get_package_versions_metadata(self, feed_id, package_name):
        ...
        :param str feed_id:
        :param str package_name:
        :rtype: :class:`<UPackLimitedPackageMetadataListResponse> <uPack-packaging.v5_1.models.UPackLimitedPackageMetadataListResponse>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
