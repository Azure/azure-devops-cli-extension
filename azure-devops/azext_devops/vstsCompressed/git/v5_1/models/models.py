...
class Attachment(Model):
    ...
    :type _links: :class:`ReferenceLinks <git.v5_1.models.ReferenceLinks>`
    :param author: The person that uploaded this attachment.
    :type author: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    ...
    :type properties: :class:`object <git.v5_1.models.object>`
...
class Change(Model):
    ...
    :type new_content: :class:`ItemContent <git.v5_1.models.ItemContent>`
...
class Comment(Model):
    ...
    :type users_liked: list of :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    """
...
class CommentThread(Model):
    ...
    :type comments: list of :class:`Comment <git.v5_1.models.Comment>`
    ...
    :type thread_context: :class:`CommentThreadContext <git.v5_1.models.CommentThreadContext>`
    """
...
class CommentThreadContext(Model):
    ...
    :type left_file_end: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    :param left_file_start: Position of first character of the thread's span in left file.
    :type left_file_start: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    :param right_file_end: Position of last character of the thread's span in right file.
    :type right_file_end: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    :param right_file_start: Position of first character of the thread's span in right file.
    :type right_file_start: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    """
...
class CommentTrackingCriteria(Model):
    ...
    :type orig_left_file_end: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    :param orig_left_file_start: Original position of first character of the thread's span in left file.
    :type orig_left_file_start: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    :param orig_right_file_end: Original position of last character of the thread's span in right file.
    :type orig_right_file_end: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
    :param orig_right_file_start: Original position of first character of the thread's span in right file.
    :type orig_right_file_start: :class:`CommentPosition <git.v5_1.models.CommentPosition>`
...
class FileDiff(Model):
    ...
    :type line_diff_blocks: list of :class:`LineDiffBlock <git.v5_1.models.LineDiffBlock>`
...
class FileDiffsCriteria(Model):
    ...
    :type file_diff_params: list of :class:`FileDiffParams <git.v5_1.models.FileDiffParams>`
...
class GitAnnotatedTag(Model):
    ...
    :type tagged_by: :class:`GitUserDate <git.v5_1.models.GitUserDate>`
    :param tagged_object: Tagged git object.
    :type tagged_object: :class:`GitObject <git.v5_1.models.GitObject>`
    :param url:
    :type url: str
    """
...
class GitAsyncRefOperation(Model):
    ...
    :type detailed_status: :class:`GitAsyncRefOperationDetail <git.v5_1.models.GitAsyncRefOperationDetail>`
    :param parameters:
    :type parameters: :class:`GitAsyncRefOperationParameters <git.v5_1.models.GitAsyncRefOperationParameters>`
    :param status:
    :type status: object
...
class GitAsyncRefOperationParameters(Model):
    ...
    :type repository: :class:`GitRepository <git.v5_1.models.GitRepository>`
    :param source: Details about the source of the cherry pick or revert operation (e.g. A pull request or a specific commit).
    :type source: :class:`GitAsyncRefOperationSource <git.v5_1.models.GitAsyncRefOperationSource>`
    """
...
class GitAsyncRefOperationSource(Model):
    ...
    :type commit_list: list of :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
...
class GitBranchStats(Model):
    ...
    :type commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
...
class GitCommitChanges(Model):
    ...
    :param changes:
    :type changes: list of :class:`object <git.v5_1.models.object>`
    """
...
class GitCommitRef(Model):
    ...
    :type author: :class:`GitUserDate <git.v5_1.models.GitUserDate>`
    ...
    :type committer: :class:`GitUserDate <git.v5_1.models.GitUserDate>`
    ...
    :type push: :class:`GitPushRef <git.v5_1.models.GitPushRef>`
    ...
    :type statuses: list of :class:`GitStatus <git.v5_1.models.GitStatus>`
    :param url: REST URL for this resource.
    :type url: str
    :param work_items: A list of workitems associated with this commit.
    :type work_items: list of :class:`ResourceRef <git.v5_1.models.ResourceRef>`
    """
...
class GitConflict(Model):
    ...
    :type merge_base_commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    :param merge_origin:
    :type merge_origin: :class:`GitMergeOriginRef <git.v5_1.models.GitMergeOriginRef>`
    :param merge_source_commit:
    :type merge_source_commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    :param merge_target_commit:
    :type merge_target_commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    :param resolution_error:
    :type resolution_error: object
    :param resolution_status:
    :type resolution_status: object
    :param resolved_by:
    :type resolved_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    :param resolved_date:
...
class GitConflictUpdateResult(Model):
    ...
    :type updated_conflict: :class:`GitConflict <git.v5_1.models.GitConflict>`
...
class GitDeletedRepository(Model):
    ...
    :type created_date: datetime
    :param deleted_by:
    :type deleted_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    :param deleted_date:
    ...
    :type name: str
    :param project:
    :type project: :class:`TeamProjectReference <git.v5_1.models.TeamProjectReference>`
    """
...
class GitForkSyncRequest(Model):
    ...
    :type _links: :class:`ReferenceLinks <git.v5_1.models.ReferenceLinks>`
    :param detailed_status:
    :type detailed_status: :class:`GitForkOperationStatusDetail <git.v5_1.models.GitForkOperationStatusDetail>`
    ...
    :type source: :class:`GlobalGitRepositoryKey <git.v5_1.models.GlobalGitRepositoryKey>`
    ...
    :type source_to_target_refs: list of :class:`SourceToTargetRef <git.v5_1.models.SourceToTargetRef>`
    :param status:
    :type status: object
    """
...
class GitImportRequest(Model):
    ...
    :type detailed_status: :class:`GitImportStatusDetail <git.v5_1.models.GitImportStatusDetail>`
    ...
    :type parameters: :class:`GitImportRequestParameters <git.v5_1.models.GitImportRequestParameters>`
...
class GitImportRequestParameters(Model):
    ...
    :type git_source: :class:`GitImportGitSource <git.v5_1.models.GitImportGitSource>`
    ...
    :type tfvc_source: :class:`GitImportTfvcSource <git.v5_1.models.GitImportTfvcSource>`
    """
...
class GitItemRequestData(Model):
    ...
    :type item_descriptors: list of :class:`GitItemDescriptor <git.v5_1.models.GitItemDescriptor>`
...
class GitPolicyConfigurationResponse(Model):
    ...
    :type policy_configurations: list of :class:`PolicyConfiguration <git.v5_1.models.PolicyConfiguration>`
    """
...
class GitPullRequest(Model):
    ...
    :type auto_complete_set_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    :param closed_by: The user who closed the pull request.
    :type closed_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    ...
    :type commits: list of :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    :param completion_options: Options which affect how the pull request will be merged when it is completed.
    :type completion_options: :class:`GitPullRequestCompletionOptions <git.v5_1.models.GitPullRequestCompletionOptions>`
    ...
    :type created_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    ...
    :type fork_source: :class:`GitForkRef <git.v5_1.models.GitForkRef>`
    :param is_draft: Draft / WIP pull request.
    :type is_draft: bool
    :param labels: The labels associated with the pull request.
    :type labels: list of :class:`WebApiTagDefinition <git.v5_1.models.WebApiTagDefinition>`
    ...
    :type merge_options: :class:`GitPullRequestMergeOptions <git.v5_1.models.GitPullRequestMergeOptions>`
    ...
    :type reviewers: list of :class:`IdentityRefWithVote <git.v5_1.models.IdentityRefWithVote>`
    ...
    :type work_item_refs: list of :class:`ResourceRef <git.v5_1.models.ResourceRef>`
    """
...
class GitPullRequestCommentThread(CommentThread):
    ...
    :type pull_request_thread_context: :class:`GitPullRequestCommentThreadContext <git.v5_1.models.GitPullRequestCommentThreadContext>`
    """
...
class GitPullRequestCommentThreadContext(Model):
    ...
    :type iteration_context: :class:`CommentIterationContext <git.v5_1.models.CommentIterationContext>`
    ...
    :type tracking_criteria: :class:`CommentTrackingCriteria <git.v5_1.models.CommentTrackingCriteria>`
    """
...
class GitPullRequestIteration(Model):
    ...
    :type change_list: list of :class:`GitPullRequestChange <git.v5_1.models.GitPullRequestChange>`
    ...
    :type common_ref_commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    ...
    :type source_ref_commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    :param target_ref_commit: The target Git commit of this iteration.
    :type target_ref_commit: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
...
class GitPullRequestIterationChanges(Model):
    ...
    :type change_entries: list of :class:`GitPullRequestChange <git.v5_1.models.GitPullRequestChange>`
...
class GitPullRequestQuery(Model):
    ...
    :type queries: list of :class:`GitPullRequestQueryInput <git.v5_1.models.GitPullRequestQueryInput>`
...
class GitPushRef(Model):
    ...
    :param pushed_by:
    :type pushed_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    :param push_id:
    :type push_id: int
    :param url:
    :type url: str
...
class GitQueryBranchStatsCriteria(Model):
    ...
    :param base_commit:
    :type base_commit: :class:`GitVersionDescriptor <git.v5_1.models.GitVersionDescriptor>`
    :param target_commits:
    :type target_commits: list of :class:`GitVersionDescriptor <git.v5_1.models.GitVersionDescriptor>`
    """
...
class GitQueryCommitsCriteria(Model):
    ...
    :type compare_version: :class:`GitVersionDescriptor <git.v5_1.models.GitVersionDescriptor>`
    ...
    :type item_version: :class:`GitVersionDescriptor <git.v5_1.models.GitVersionDescriptor>`
...
class GitRef(Model):
    ...
    :type _links: :class:`ReferenceLinks <git.v5_1.models.ReferenceLinks>`
    :param creator:
    :type creator: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    :param is_locked:
    :type is_locked: bool
    :param is_locked_by:
    :type is_locked_by: :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    :param name:
    :type name: str
    :param object_id:
    :type object_id: str
...
class GitRepository(Model):
    ...
    :type parent_repository: :class:`GitRepositoryRef <git.v5_1.models.GitRepositoryRef>`
    :param project:
    :type project: :class:`TeamProjectReference <git.v5_1.models.TeamProjectReference>`
    :param remote_url:
    :type remote_url: str
...
class GitRepositoryRef(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <git.v5_1.models.TeamProjectCollectionReference>`
    :param id:
    :type id: str
    :param is_fork: True if the repository was created as a fork
    :type is_fork: bool
...
class GitStatus(Model):
    ...
    :type context: :class:`GitStatusContext <git.v5_1.models.GitStatusContext>`
...
class GitTreeDiff(Model):
    ...
    :type diff_entries: list of :class:`GitTreeDiffEntry <git.v5_1.models.GitTreeDiffEntry>`
...
class GitTreeDiffResponse(Model):
    ...
    :param tree_diff:
    :type tree_diff: :class:`GitTreeDiff <git.v5_1.models.GitTreeDiff>`
    """
...
class GitTreeRef(Model):
    ...
    :type tree_entries: list of :class:`GitTreeEntryRef <git.v5_1.models.GitTreeEntryRef>`
...
class IdentityRefWithVote(IdentityRef):
    ...
    :type voted_for: list of :class:`IdentityRefWithVote <git.v5_1.models.IdentityRefWithVote>`
    """
...
class ItemModel(Model):
    ...
    :type content_metadata: :class:`FileContentMetadata <git.v5_1.models.FileContentMetadata>`
    :param is_folder:
    :type is_folder: bool
    :param is_sym_link:
...
class PolicyConfigurationRef(Model):
    ...
    :type type: :class:`PolicyTypeRef <microsoft.-team-foundation.-policy.-web-api.v5_1.models.PolicyTypeRef>`
...
class ShareNotificationContext(Model):
    ...
    :type receivers: list of :class:`IdentityRef <git.v5_1.models.IdentityRef>`
    """
...
class GitItem(ItemModel):
    ...
    :type latest_processed_change: :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
...
class GitMerge(GitMergeParameters):
    ...
    :type detailed_status: :class:`GitMergeOperationStatusDetail <git.v5_1.models.GitMergeOperationStatusDetail>`
...
class GitPush(GitPushRef):
    ...
    :type commits: list of :class:`GitCommitRef <git.v5_1.models.GitCommitRef>`
    :param ref_updates:
    :type ref_updates: list of :class:`GitRefUpdate <git.v5_1.models.GitRefUpdate>`
    :param repository:
    :type repository: :class:`GitRepository <git.v5_1.models.GitRepository>`
    """
...
class PolicyConfiguration(VersionedPolicyConfigurationRef):
    ...
    :type _links: :class:`ReferenceLinks <microsoft.-team-foundation.-policy.-web-api.v5_1.models.ReferenceLinks>`
    :param created_by: A reference to the identity that created the policy.
    :type created_by: :class:`IdentityRef <microsoft.-team-foundation.-policy.-web-api.v5_1.models.IdentityRef>`
