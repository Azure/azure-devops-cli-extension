...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <uPack.v5_1.models.ReferenceLinks>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <uPack.v5_1.models.JsonPatchOperation>`
    """
...
class UPackPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <uPack.v5_1.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <uPack.v5_1.models.MinimalPackageDetails>`
    """
