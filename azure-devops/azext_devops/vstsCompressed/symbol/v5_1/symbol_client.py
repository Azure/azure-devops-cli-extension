...
class SymbolClient(VssClient):
    ...
    def create_requests(self, request_to_create):
        ...
        :param :class:`<Request> <symbol.v5_1.models.Request>` request_to_create: The symbol request to create.
        :rtype: :class:`<Request> <symbol.v5_1.models.Request>`
        """
    ...
    def create_requests_request_id_debug_entries(self, batch, request_id, collection):
        ...
        :param :class:`<DebugEntryCreateBatch> <symbol.v5_1.models.DebugEntryCreateBatch>` batch: A batch that contains debug entries to create.
    ...
    def update_requests_request_id(self, update_request, request_id):
        ...
        :param :class:`<Request> <symbol.v5_1.models.Request>` update_request: The symbol request.
        :param str request_id: The symbol request identifier.
        :rtype: :class:`<Request> <symbol.v5_1.models.Request>`
        """
        route_values = {}
