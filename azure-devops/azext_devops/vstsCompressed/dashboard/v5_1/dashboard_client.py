...
class DashboardClient(VssClient):
    ...
    def create_dashboard(self, dashboard, team_context):
        ...
        :param :class:`<Dashboard> <dashboard.v5_1.models.Dashboard>` dashboard: The initial state of the dashboard
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<Dashboard> <dashboard.v5_1.models.Dashboard>`
        """
        project = None
        team = None
    ...
    def get_dashboards(self, team_context):
        ...
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<DashboardGroup> <dashboard.v5_1.models.DashboardGroup>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def replace_dashboard(self, dashboard, team_context, dashboard_id):
        ...
        :param :class:`<Dashboard> <dashboard.v5_1.models.Dashboard>` dashboard: The Configuration of the dashboard to replace.
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
    ...
    def replace_dashboards(self, group, team_context):
        ...
        :param :class:`<DashboardGroup> <dashboard.v5_1.models.DashboardGroup>` group:
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<DashboardGroup> <dashboard.v5_1.models.DashboardGroup>`
        """
        project = None
    ...
    def create_widget(self, widget, team_context, dashboard_id):
        ...
        :param :class:`<Widget> <dashboard.v5_1.models.Widget>` widget: State of the widget to add
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str dashboard_id: ID of dashboard the widget will be added to.
        :rtype: :class:`<Widget> <dashboard.v5_1.models.Widget>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_widgets(self, team_context, dashboard_id, eTag=None):
        ...
        :rtype: :class:`<WidgetsVersionedList> <dashboard.v5_1.models.WidgetsVersionedList>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def replace_widget(self, widget, team_context, dashboard_id, widget_id):
        ...
        :param :class:`<Widget> <dashboard.v5_1.models.Widget>` widget: State to be written for the widget.
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str dashboard_id: ID of the dashboard containing the widget.
        :param str widget_id: ID of the widget to update.
        :rtype: :class:`<Widget> <dashboard.v5_1.models.Widget>`
    ...
    def update_widget(self, widget, team_context, dashboard_id, widget_id):
        ...
        :param :class:`<Widget> <dashboard.v5_1.models.Widget>` widget: Description of the widget changes to apply. All non-null fields will be replaced.
        :param :class:`<TeamContext> <dashboard.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str dashboard_id: ID of the dashboard containing the widget.
        :param str widget_id: ID of the widget to update.
        :rtype: :class:`<Widget> <dashboard.v5_1.models.Widget>`
    ...
    def get_widget_metadata(self, contribution_id, project=None):
        ...
        :rtype: :class:`<WidgetMetadataResponse> <dashboard.v5_1.models.WidgetMetadataResponse>`
        """
        route_values = {}
        if project is not None:
    ...
    def get_widget_types(self, scope, project=None):
        ...
        :param str scope:
        :param str project: Project ID or project name
        :rtype: :class:`<WidgetTypesResponse> <dashboard.v5_1.models.WidgetTypesResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
