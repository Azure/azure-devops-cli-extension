...
class Dashboard(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <dashboard.v5_1.models.ReferenceLinks>`
    ...
    :type widgets: list of :class:`Widget <dashboard.v5_1.models.Widget>`
    """
...
class DashboardGroup(Model):
    ...
    :type dashboard_entries: list of :class:`DashboardGroupEntry <dashboard.v5_1.models.DashboardGroupEntry>`
...
class Widget(Model):
    ...
    :type allowed_sizes: list of :class:`WidgetSize <dashboard.v5_1.models.WidgetSize>`
    ...
    :type dashboard: :class:`Dashboard <dashboard.v5_1.models.Dashboard>`
    :param eTag:
    :type eTag: str
    :param id:
    :type id: str
    ...
    :type lightbox_options: :class:`LightboxOptions <dashboard.v5_1.models.LightboxOptions>`
    :param loading_image_url:
    :type loading_image_url: str
    :param name:
    :type name: str
    :param position:
    :type position: :class:`WidgetPosition <dashboard.v5_1.models.WidgetPosition>`
    :param settings:
    :type settings: str
    :param settings_version:
    :type settings_version: :class:`SemanticVersion <dashboard.v5_1.models.SemanticVersion>`
    :param size:
    :type size: :class:`WidgetSize <dashboard.v5_1.models.WidgetSize>`
    :param type_id:
    :type type_id: str
    :param url:
    :type url: str
...
class WidgetMetadataResponse(Model):
    ...
    :type widget_metadata: :class:`WidgetMetadata <dashboard.v5_1.models.WidgetMetadata>`
    """
...
class WidgetTypesResponse(Model):
    ...
    :type uri: str
    :param widget_types:
    :type widget_types: list of :class:`WidgetMetadata <dashboard.v5_1.models.WidgetMetadata>`
    """
