...
class AggregatedDataForResultTrend(Model):
    ...
    :type test_results_context: :class:`TestResultsContext <test.v5_1.models.TestResultsContext>`
    :param total_tests:
...
class AggregatedResultsAnalysis(Model):
    ...
    :type previous_context: :class:`TestResultsContext <test.v5_1.models.TestResultsContext>`
    :param results_by_outcome:
    :type results_by_outcome: dict
    :param results_difference:
    :type results_difference: :class:`AggregatedResultsDifference <test.v5_1.models.AggregatedResultsDifference>`
...
class BuildConfiguration(Model):
    ...
    :type platform: str
    :param project:
    :type project: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class BuildCoverage(Model):
    ...
    :type configuration: :class:`BuildConfiguration <test.v5_1.models.BuildConfiguration>`
    :param last_error: Last Error
    :type last_error: str
    :param modules: List of Modules
    :type modules: list of :class:`ModuleCoverage <test.v5_1.models.ModuleCoverage>`
    :param state: State
    :type state: str
    """
...
class CloneOperationInformation(Model):
    ...
    :type clone_statistics: :class:`CloneStatistics <test.v5_1.models.CloneStatistics>`
    ...
    :type destination_object: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param destination_plan: Shallow reference of the destination
    :type destination_plan: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param destination_project: Shallow reference of the destination
    :type destination_project: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type source_object: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param source_plan: Shallow reference of the source
    :type source_plan: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param source_project: Shallow reference of the source
    :type source_project: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class CodeCoverageData(Model):
    ...
    :type coverage_stats: list of :class:`CodeCoverageStatistics <test.v5_1.models.CodeCoverageStatistics>`
    """
...
class CodeCoverageSummary(Model):
    ...
    :type build: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param coverage_data: List of coverage data and details for the build
    :type coverage_data: list of :class:`CodeCoverageData <test.v5_1.models.CodeCoverageData>`
    :param delta_build: Uri of build against which difference in coverage is computed
    :type delta_build: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    """
...
class FailingSince(Model):
    ...
    :type build: :class:`BuildReference <test.v5_1.models.BuildReference>`
    :param date: Time since failing.
    :type date: datetime
    :param release: Release reference since failing.
    :type release: :class:`ReleaseReference <test.v5_1.models.ReleaseReference>`
    """
...
class FunctionCoverage(Model):
    ...
    :param statistics:
    :type statistics: :class:`CoverageStatistics <test.v5_1.models.CoverageStatistics>`
    """
...
class LastResultDetails(Model):
    ...
    :type duration: long
    :param run_by:
    :type run_by: :class:`IdentityRef <test.v5_1.models.IdentityRef>`
    """
...
class LinkedWorkItemsQueryResult(Model):
    ...
    :param work_items:
    :type work_items: list of :class:`WorkItemReference <test.v5_1.models.WorkItemReference>`
    """
...
class ModuleCoverage(Model):
    ...
    :type file_url: str
    :param functions:
    :type functions: list of :class:`FunctionCoverage <test.v5_1.models.FunctionCoverage>`
    :param name:
    :type name: str
    :param signature:
    :type signature: str
...
class PlanUpdateModel(Model):
    ...
    :type area: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param automated_test_environment:
    :type automated_test_environment: :class:`TestEnvironment <test.v5_1.models.TestEnvironment>`
    :param automated_test_settings:
    :type automated_test_settings: :class:`TestSettings <test.v5_1.models.TestSettings>`
    ...
    :type build_definition: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type manual_test_environment: :class:`TestEnvironment <test.v5_1.models.TestEnvironment>`
    :param manual_test_settings:
    :type manual_test_settings: :class:`TestSettings <test.v5_1.models.TestSettings>`
    :param name: Name of the test plan.
    :type name: str
    :param owner: Owner of the test plan.
    :type owner: :class:`IdentityRef <test.v5_1.models.IdentityRef>`
    ...
    :type release_environment_definition: :class:`ReleaseEnvironmentDefinitionReference <test.v5_1.models.ReleaseEnvironmentDefinitionReference>`
    ...
    :type test_outcome_settings: :class:`TestOutcomeSettings <test.v5_1.models.TestOutcomeSettings>`
    """
...
class PointsFilter(Model):
    ...
    :type testers: list of :class:`IdentityRef <test.v5_1.models.IdentityRef>`
    """
...
class PointAssignment(Model):
    ...
    :type configuration: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param tester: Tester that was assigned to the test case
    :type tester: :class:`IdentityRef <test.v5_1.models.IdentityRef>`
    """
...
class ResultRetentionSettings(Model):
    ...
    :type last_updated_by: :class:`IdentityRef <test.v5_1.models.IdentityRef>`
...
class RunCreateModel(Model):
    ...
    :type build_reference: :class:`BuildConfiguration <test.v5_1.models.BuildConfiguration>`
    ...
    :type custom_test_fields: list of :class:`CustomTestField <test.v5_1.models.CustomTestField>`
    :param dtl_aut_environment: An abstracted reference to DtlAutEnvironment.
    :type dtl_aut_environment: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param dtl_test_environment: An abstracted reference to DtlTestEnvironment.
    :type dtl_test_environment: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param due_date: Due date and time for test run.
    :type due_date: str
    :param environment_details:
    :type environment_details: :class:`DtlEnvironmentDetails <test.v5_1.models.DtlEnvironmentDetails>`
    :param error_message: Error message associated with the run.
    :type error_message: str
    :param filter:
    :type filter: :class:`RunFilter <test.v5_1.models.RunFilter>`
    ...
    :type plan: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type release_reference: :class:`ReleaseReference <test.v5_1.models.ReleaseReference>`
    ...
    :type run_summary: list of :class:`RunSummaryModel <test.v5_1.models.RunSummaryModel>`
    :param run_timeout:
    ...
    :type test_settings: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class RunStatistic(Model):
    ...
    :type resolution_state: :class:`TestResolutionState <test.v5_1.models.TestResolutionState>`
...
class RunUpdateModel(Model):
    ...
    :type dtl_environment: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param dtl_environment_details:
    :type dtl_environment_details: :class:`DtlEnvironmentDetails <test.v5_1.models.DtlEnvironmentDetails>`
    :param due_date: Due date and time for test run.
    :type due_date: str
    :param error_message: Error message associated with the run.
    :type error_message: str
    ...
    :type log_entries: list of :class:`TestMessageLogDetails <test.v5_1.models.TestMessageLogDetails>`
    :param name: Name of the test run.
    :type name: str
...
class SuiteTestCase(Model):
    ...
    :type point_assignments: list of :class:`PointAssignment <test.v5_1.models.PointAssignment>`
    :param test_case: Test case workItem reference.
    :type test_case: :class:`WorkItemReference <test.v5_1.models.WorkItemReference>`
    """
...
class SuiteTestCaseUpdateModel(Model):
    ...
    :type configurations: list of :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    """
...
class SuiteUpdateModel(Model):
    ...
    :type default_configurations: list of :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param default_testers: Shallow reference of test suite.
    :type default_testers: list of :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type parent: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class TestCaseResult(Model):
    ...
    :type associated_bugs: list of :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type build_reference: :class:`BuildReference <test.v5_1.models.BuildReference>`
    ...
    :type custom_fields: list of :class:`CustomTestField <test.v5_1.models.CustomTestField>`
    ...
    :type failing_since: :class:`FailingSince <test.v5_1.models.FailingSince>`
    ...
    :type iteration_details: list of :class:`TestIterationDetailsModel <test.v5_1.models.TestIterationDetailsModel>`
    ...
    :type release: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type sub_results: list of :class:`TestSubResult <test.v5_1.models.TestSubResult>`
    :param test_case: Reference to the test executed.
    :type test_case: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type test_plan: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param test_point: Reference to the test point executed.
    :type test_point: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param test_run: Reference to test run.
    :type test_run: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param test_suite: Reference to test suite test case workitem is part of.
    :type test_suite: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class TestCaseResultUpdateModel(Model):
    ...
    :param test_result:
    :type test_result: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    """
...
class TestConfiguration(Model):
    ...
    :type values: list of :class:`NameValuePair <test.v5_1.models.NameValuePair>`
    """
...
class TestFailuresAnalysis(Model):
    ...
    :type existing_failures: :class:`TestFailureDetails <test.v5_1.models.TestFailureDetails>`
    :param fixed_tests:
    :type fixed_tests: :class:`TestFailureDetails <test.v5_1.models.TestFailureDetails>`
    :param new_failures:
    :type new_failures: :class:`TestFailureDetails <test.v5_1.models.TestFailureDetails>`
    :param previous_context:
    :type previous_context: :class:`TestResultsContext <test.v5_1.models.TestResultsContext>`
    """
...
class TestFailureDetails(Model):
    ...
    :type count: int
    :param test_results:
    :type test_results: list of :class:`TestCaseResultIdentifier <test.v5_1.models.TestCaseResultIdentifier>`
    """
...
class TestHistoryQuery(Model):
    ...
    :type results_for_group: list of :class:`TestResultHistoryForGroup <test.v5_1.models.TestResultHistoryForGroup>`
...
class TestIterationDetailsModel(Model):
    ...
    :type action_results: list of :class:`TestActionResultModel <test.v5_1.models.TestActionResultModel>`
    :param attachments: Refence to attachments in test iteration result.
    :type attachments: list of :class:`TestCaseResultAttachmentModel <test.v5_1.models.TestCaseResultAttachmentModel>`
    ...
    :type parameters: list of :class:`TestResultParameterModel <test.v5_1.models.TestResultParameterModel>`
...
class TestPlan(Model):
    ...
    :type previous_build: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type root_suite: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param start_date: Start date for the test plan.
    ...
    :type test_outcome_settings: :class:`TestOutcomeSettings <test.v5_1.models.TestOutcomeSettings>`
    :param updated_by:
    :type updated_by: :class:`IdentityRef <test.v5_1.models.IdentityRef>`
    :param updated_date:
...
class TestPlanCloneRequest(Model):
    ...
    :type destination_test_plan: :class:`TestPlan <test.v5_1.models.TestPlan>`
    :param options:
    :type options: :class:`CloneOptions <test.v5_1.models.CloneOptions>`
    :param suite_ids:
    :type suite_ids: list of int
    """
...
class TestPoint(Model):
    ...
    :type assigned_to: :class:`IdentityRef <test.v5_1.models.IdentityRef>`
    ...
    :type last_result: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param last_result_details: Last result details of test point. Type LastResultDetails.
    :type last_result_details: :class:`LastResultDetails <test.v5_1.models.LastResultDetails>`
    ...
    :type last_test_run: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    ...
    :type suite: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class TestPointsQuery(Model):
    ...
    :type points: list of :class:`TestPoint <test.v5_1.models.TestPoint>`
    :param points_filter: Filter
    :type points_filter: :class:`PointsFilter <test.v5_1.models.PointsFilter>`
...
class TestResultsDetails(Model):
    ...
    :type results_for_group: list of :class:`TestResultsDetailsForGroup <test.v5_1.models.TestResultsDetailsForGroup>`
    """
...
class TestResultsDetailsForGroup(Model):
    ...
    :type group_by_value: object
    :param results:
    :type results: list of :class:`TestCaseResult <test.v5_1.models.TestCaseResult>`
...
class TestResultsGroupsForBuild(Model):
    ...
    :type fields: list of :class:`FieldDetailsForTestResults <test.v5_1.models.FieldDetailsForTestResults>`
    """
...
class TestResultsQuery(Model):
    ...
    :type results_filter: :class:`ResultsFilter <test.v5_1.models.ResultsFilter>`
    """
...
class TestResultDocument(Model):
    ...
    :type operation_reference: :class:`TestOperationReference <test.v5_1.models.TestOperationReference>`
    :param payload:
    :type payload: :class:`TestResultPayload <test.v5_1.models.TestResultPayload>`
    """
...
class TestResultHistory(Model):
    ...
    :type group_by_field: str
    :param results_for_group:
    :type results_for_group: list of :class:`TestResultHistoryDetailsForGroup <test.v5_1.models.TestResultHistoryDetailsForGroup>`
    """
...
class TestResultHistoryDetailsForGroup(Model):
    ...
    :type group_by_value: object
    :param latest_result:
    :type latest_result: :class:`TestCaseResult <test.v5_1.models.TestCaseResult>`
    """
...
class TestResultSummary(Model):
    ...
    :type aggregated_results_analysis: :class:`AggregatedResultsAnalysis <test.v5_1.models.AggregatedResultsAnalysis>`
    :param no_config_runs_count:
    :type no_config_runs_count: int
    :param team_project:
    :type team_project: :class:`TeamProjectReference <test.v5_1.models.TeamProjectReference>`
    :param test_failures:
    :type test_failures: :class:`TestFailuresAnalysis <test.v5_1.models.TestFailuresAnalysis>`
    :param test_results_context:
    :type test_results_context: :class:`TestResultsContext <test.v5_1.models.TestResultsContext>`
...
class TestRun(Model):
    ...
    :type build_configuration: :class:`BuildConfiguration <test.v5_1.models.BuildConfiguration>`
    :param comment: Comments entered by those analyzing the run.
    :type comment: str
    :param completed_date: Completed date time of the run.
    :type completed_date: datetime
    ...
    :type dtl_environment_creation_details: :class:`DtlEnvironmentDetails <test.v5_1.models.DtlEnvironmentDetails>`
    :param due_date: Due date and time for test run.
    ...
    :type run_statistics: list of :class:`RunStatistic <test.v5_1.models.RunStatistic>`
    :param started_date: Start date time of the run.
    :type started_date: datetime
    ...
    :type test_environment: :class:`TestEnvironment <test.v5_1.models.TestEnvironment>`
...
class TestRunStatistic(Model):
    ...
    :param run:
    :type run: :class:`ShallowReference <test.v5_1.models.ShallowReference>`
    :param run_statistics:
    :type run_statistics: list of :class:`RunStatistic <test.v5_1.models.RunStatistic>`
    """
...
class TestSession(Model):
    ...
    :type property_bag: :class:`PropertyBag <test.v5_1.models.PropertyBag>`
...
class TestSubResult(Model):
    ...
    :type test_result: :class:`TestCaseResultIdentifier <test.v5_1.models.TestCaseResultIdentifier>`
...
class TestSuite(Model):
    ...
    :type children: list of :class:`TestSuite <test.v5_1.models.TestSuite>`
    ...
    :type suites: list of :class:`ShallowReference <test.v5_1.models.ShallowReference>`
...
class TestSuiteCloneRequest(Model):
    ...
    :type clone_options: :class:`CloneOptions <test.v5_1.models.CloneOptions>`
...
class TestSummaryForWorkItem(Model):
    ...
    :param summary:
    :type summary: :class:`AggregatedDataForResultTrend <test.v5_1.models.AggregatedDataForResultTrend>`
    :param work_item:
    :type work_item: :class:`WorkItemReference <test.v5_1.models.WorkItemReference>`
    """
...
class TestToWorkItemLinks(Model):
    ...
    :param test:
    :type test: :class:`TestMethod <test.v5_1.models.TestMethod>`
    :param work_items:
    :type work_items: list of :class:`WorkItemReference <test.v5_1.models.WorkItemReference>`
    """
...
class WorkItemToTestLinks(Model):
    ...
    :type executed_in: object
    :param tests:
    :type tests: list of :class:`TestMethod <test.v5_1.models.TestMethod>`
    :param work_item:
    :type work_item: :class:`WorkItemReference <test.v5_1.models.WorkItemReference>`
    """
...
class TestActionResultModel(TestResultModelBase):
    ...
    :type shared_step_model: :class:`SharedStepModel <test.v5_1.models.SharedStepModel>`
    :param step_identifier: This is step Id of test case. For shared step, it is step Id of shared step in test case workitem; step Id in shared step. Example: TestCase workitem has two steps: 1) Normal step with Id = 1 2) Shared Step with Id = 2. Inside shared step: a) Normal Step with Id = 1 Value for StepIdentifier for First step: "1" Second step: "2;1"
    :type step_identifier: str
