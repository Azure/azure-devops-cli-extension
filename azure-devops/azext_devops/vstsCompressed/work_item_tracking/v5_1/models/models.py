...
class AccountMyWorkResult(Model):
    ...
    :type work_item_details: list of :class:`AccountWorkWorkItemModel <work-item-tracking.v5_1.models.AccountWorkWorkItemModel>`
    """
...
class ProjectWorkItemStateColors(Model):
    ...
    :type work_item_type_state_colors: list of :class:`WorkItemTypeStateColors <work-item-tracking.v5_1.models.WorkItemTypeStateColors>`
    """
...
class QueryHierarchyItemsResult(Model):
    ...
    :type value: list of :class:`QueryHierarchyItem <work-item-tracking.v5_1.models.QueryHierarchyItem>`
    """
...
class WorkItemLink(Model):
    ...
    :type source: :class:`WorkItemReference <work-item-tracking.v5_1.models.WorkItemReference>`
    :param target: The target work item.
    :type target: :class:`WorkItemReference <work-item-tracking.v5_1.models.WorkItemReference>`
    """
...
class WorkItemQueryClause(Model):
    ...
    :type clauses: list of :class:`WorkItemQueryClause <work-item-tracking.v5_1.models.WorkItemQueryClause>`
    :param field: Field associated with condition
    :type field: :class:`WorkItemFieldReference <work-item-tracking.v5_1.models.WorkItemFieldReference>`
    :param field_value: Right side of the condition when a field to field comparison
    :type field_value: :class:`WorkItemFieldReference <work-item-tracking.v5_1.models.WorkItemFieldReference>`
    ...
    :type operator: :class:`WorkItemFieldOperation <work-item-tracking.v5_1.models.WorkItemFieldOperation>`
...
class WorkItemQueryResult(Model):
    ...
    :type columns: list of :class:`WorkItemFieldReference <work-item-tracking.v5_1.models.WorkItemFieldReference>`
    ...
    :type sort_columns: list of :class:`WorkItemQuerySortColumn <work-item-tracking.v5_1.models.WorkItemQuerySortColumn>`
    :param work_item_relations: The work item links returned by the query.
    :type work_item_relations: list of :class:`WorkItemLink <work-item-tracking.v5_1.models.WorkItemLink>`
    :param work_items: The work items returned by the query.
    :type work_items: list of :class:`WorkItemReference <work-item-tracking.v5_1.models.WorkItemReference>`
    """
...
class WorkItemRelationUpdates(Model):
    ...
    :type added: list of :class:`WorkItemRelation <work-item-tracking.v5_1.models.WorkItemRelation>`
    :param removed: List of removed relations.
    :type removed: list of :class:`WorkItemRelation <work-item-tracking.v5_1.models.WorkItemRelation>`
    :param updated: List of updated relations.
    :type updated: list of :class:`WorkItemRelation <work-item-tracking.v5_1.models.WorkItemRelation>`
    """
...
class WorkItemTypeFieldInstanceBase(WorkItemFieldReference):
    ...
    :type dependent_fields: list of :class:`WorkItemFieldReference <work-item-tracking.v5_1.models.WorkItemFieldReference>`
...
class WorkItemTypeStateColors(Model):
    ...
    :type state_colors: list of :class:`WorkItemStateColor <work-item-tracking.v5_1.models.WorkItemStateColor>`
...
class AccountRecentActivityWorkItemModel2(AccountRecentActivityWorkItemModelBase):
    ...
    :type work_item_type: str
    :param assigned_to: Assigned To
    :type assigned_to: :class:`IdentityRef <work-item-tracking.v5_1.models.IdentityRef>`
    """
...
class WorkItemDelete(WorkItemDeleteReference):
    ...
    :type resource: :class:`WorkItem <work-item-tracking.v5_1.models.WorkItem>`
    """
...
class WorkItemType(WorkItemTrackingResource):
    ...
    :type field_instances: list of :class:`WorkItemTypeFieldInstance <work-item-tracking.v5_1.models.WorkItemTypeFieldInstance>`
    :param fields: The fields that exist on the work item type.
    :type fields: list of :class:`WorkItemTypeFieldInstance <work-item-tracking.v5_1.models.WorkItemTypeFieldInstance>`
    :param icon: The icon of the work item type.
    :type icon: :class:`WorkItemIcon <work-item-tracking.v5_1.models.WorkItemIcon>`
    ...
    :type states: list of :class:`WorkItemStateColor <work-item-tracking.v5_1.models.WorkItemStateColor>`
...
class WorkItemTypeCategory(WorkItemTrackingResource):
    ...
    :type default_work_item_type: :class:`WorkItemTypeReference <work-item-tracking.v5_1.models.WorkItemTypeReference>`
    ...
    :type work_item_types: list of :class:`WorkItemTypeReference <work-item-tracking.v5_1.models.WorkItemTypeReference>`
    """
...
class WorkItemUpdate(WorkItemTrackingResource):
    ...
    :type relations: :class:`WorkItemRelationUpdates <work-item-tracking.v5_1.models.WorkItemRelationUpdates>`
    :param rev: The revision number of work item update.
    :type rev: int
    :param revised_by: Identity for the work item update.
    :type revised_by: :class:`IdentityReference <work-item-tracking.v5_1.models.IdentityReference>`
...
class QueryHierarchyItem(WorkItemTrackingResource):
    ...
    :type children: list of :class:`QueryHierarchyItem <work-item-tracking.v5_1.models.QueryHierarchyItem>`
    :param clauses: The clauses for a flat query.
    :type clauses: :class:`WorkItemQueryClause <work-item-tracking.v5_1.models.WorkItemQueryClause>`
    :param columns: The columns of the query.
    :type columns: list of :class:`WorkItemFieldReference <work-item-tracking.v5_1.models.WorkItemFieldReference>`
    :param created_by: The identity who created the query item.
    :type created_by: :class:`IdentityReference <work-item-tracking.v5_1.models.IdentityReference>`
    ...
    :type last_executed_by: :class:`IdentityReference <work-item-tracking.v5_1.models.IdentityReference>`
    ...
    :type last_modified_by: :class:`IdentityReference <work-item-tracking.v5_1.models.IdentityReference>`
    :param last_modified_date: When the query item was last modified.
    :type last_modified_date: datetime
    :param link_clauses: The link query clause.
    :type link_clauses: :class:`WorkItemQueryClause <work-item-tracking.v5_1.models.WorkItemQueryClause>`
    ...
    :type source_clauses: :class:`WorkItemQueryClause <work-item-tracking.v5_1.models.WorkItemQueryClause>`
    :param target_clauses: The target clauses in a tree or one-hop link query.
    :type target_clauses: :class:`WorkItemQueryClause <work-item-tracking.v5_1.models.WorkItemQueryClause>`
...
class WorkItem(WorkItemTrackingResource):
    ...
    :type comment_version_ref: :class:`WorkItemCommentVersionRef <work-item-tracking.v5_1.models.WorkItemCommentVersionRef>`
    :param fields: Map of field and values for the work item.
    :type fields: dict
    :param id: The work item ID.
    :type id: int
    :param relations: Relations of the work item.
    :type relations: list of :class:`WorkItemRelation <work-item-tracking.v5_1.models.WorkItemRelation>`
...
class WorkItemClassificationNode(WorkItemTrackingResource):
    ...
    :type children: list of :class:`WorkItemClassificationNode <work-item-tracking.v5_1.models.WorkItemClassificationNode>`
...
class WorkItemComments(WorkItemTrackingResource):
    ...
    :type comments: list of :class:`WorkItemComment <work-item-tracking.v5_1.models.WorkItemComment>`
...
class WorkItemField(WorkItemTrackingResource):
    ...
    :type supported_operations: list of :class:`WorkItemFieldOperation <work-item-tracking.v5_1.models.WorkItemFieldOperation>`
