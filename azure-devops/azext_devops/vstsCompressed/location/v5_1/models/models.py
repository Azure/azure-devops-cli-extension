...
class ConnectionData(Model):
    ...
    :type authenticated_user: :class:`Identity <locations.v5_1.models.Identity>`
    ...
    :type authorized_user: :class:`Identity <locations.v5_1.models.Identity>`
    ...
    :type location_service_data: :class:`LocationServiceData <locations.v5_1.models.LocationServiceData>`
...
class LocationServiceData(Model):
    ...
    :type access_mappings: list of :class:`AccessMapping <locations.v5_1.models.AccessMapping>`
    ...
    :type service_definitions: list of :class:`ServiceDefinition <locations.v5_1.models.ServiceDefinition>`
...
class ServiceDefinition(Model):
    ...
    :type location_mappings: list of :class:`LocationMapping <locations.v5_1.models.LocationMapping>`
    ...
    :param properties:
    :type properties: :class:`object <locations.v5_1.models.object>`
    :param relative_path:
