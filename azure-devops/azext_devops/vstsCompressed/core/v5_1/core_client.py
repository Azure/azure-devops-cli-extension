...
class CoreClient(VssClient):
    ...
    def set_project_avatar(self, avatar_blob, project_id):
        ...
        :param :class:`<ProjectAvatar> <core.v5_1.models.ProjectAvatar>` avatar_blob:
        :param str project_id: The id or name of the project
        """
        route_values = {}
        if project_id is not None:
    ...
    def create_connected_service(self, connected_service_creation_data, project_id):
        ...
        [Preview API]
        :param :class:`<WebApiConnectedServiceDetails> <core.v5_1.models.WebApiConnectedServiceDetails>` connected_service_creation_data:
        :param str project_id:
        :rtype: :class:`<WebApiConnectedService> <core.v5_1.models.WebApiConnectedService>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def get_connected_service_details(self, project_id, name):
        ...
        :param str project_id:
        :param str name:
        :rtype: :class:`<WebApiConnectedServiceDetails> <core.v5_1.models.WebApiConnectedServiceDetails>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def get_process_by_id(self, process_id):
        ...
        :rtype: :class:`<Process> <core.v5_1.models.Process>`
        """
        route_values = {}
    ...
    def get_project_collection(self, collection_id):
        ...
        :rtype: :class:`<TeamProjectCollection> <core.v5_1.models.TeamProjectCollection>`
        """
        route_values = {}
    ...
    def get_project(self, project_id, include_capabilities=None, include_history=None):
        ...
        :rtype: :class:`<TeamProject> <core.v5_1.models.TeamProject>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def queue_create_project(self, project_to_create):
        ...
        :param :class:`<TeamProject> <core.v5_1.models.TeamProject>` project_to_create: The project to create.
        :rtype: :class:`<OperationReference> <core.v5_1.models.OperationReference>`
        """
    ...
    def update_project(self, project_update, project_id):
        ...
        :param :class:`<TeamProject> <core.v5_1.models.TeamProject>` project_update: The updates for the project. The state must be set to wellFormed to restore the project.
    ...
    def create_or_update_proxy(self, proxy):
        """CreateOrUpdateProxy.
        [Preview API]
        :param :class:`<Proxy> <core.v5_1.models.Proxy>` proxy:
        :rtype: :class:`<Proxy> <core.v5_1.models.Proxy>`
        """
    ...
    def create_team(self, team, project_id):
        ...
        :param :class:`<WebApiTeam> <core.v5_1.models.WebApiTeam>` team: The team data used to create the team.
        :param str project_id: The name or ID (GUID) of the team project in which to create the team.
        :rtype: :class:`<WebApiTeam> <core.v5_1.models.WebApiTeam>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def update_team(self, team_data, project_id, team_id):
        ...
        :param :class:`<WebApiTeam> <core.v5_1.models.WebApiTeam>` team_data:
