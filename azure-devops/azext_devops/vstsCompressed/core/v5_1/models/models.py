...
class ProjectInfo(Model):
    ...
    :type properties: list of :class:`ProjectProperty <core.v5_1.models.ProjectProperty>`
...
class Proxy(Model):
    ...
    :param authorization:
    :type authorization: :class:`ProxyAuthorization <core.v5_1.models.ProxyAuthorization>`
...
class TeamMember(Model):
    ...
    :param identity:
    :type identity: :class:`IdentityRef <microsoft.-visual-studio.-services.-web-api.v5_1.models.IdentityRef>`
    :param is_team_admin:
...
class Process(ProcessReference):
    ...
    :type url: str
    :param _links:
    :type _links: :class:`ReferenceLinks <core.v5_1.models.ReferenceLinks>`
    :param description:
    :type description: str
    :param id:
    :type id: str
...
class TeamProject(TeamProjectReference):
    ...
    :type default_team: :class:`WebApiTeamRef <core.v5_1.models.WebApiTeamRef>`
    """
...
class WebApiConnectedService(WebApiConnectedServiceRef):
    ...
    :type authenticated_by: :class:`IdentityRef <core.v5_1.models.IdentityRef>`
    ...
    :type project: :class:`TeamProjectReference <core.v5_1.models.TeamProjectReference>`
...
class WebApiConnectedServiceDetails(WebApiConnectedServiceRef):
    ...
    :type connected_service_meta_data: :class:`WebApiConnectedService <core.v5_1.models.WebApiConnectedService>`
