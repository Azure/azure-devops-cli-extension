...
class GroupEntitlement(Model):
    ...
    :type extension_rules: list of :class:`Extension <member-entitlement-management.v5_1.models.Extension>`
    :param group: Member reference.
    :type group: :class:`GraphGroup <member-entitlement-management.v5_1.models.GraphGroup>`
    ...
    :type license_rule: :class:`AccessLevel <member-entitlement-management.v5_1.models.AccessLevel>`
    :param members: Group members. Only used when creating a new group.
    :type members: list of :class:`UserEntitlement <member-entitlement-management.v5_1.models.UserEntitlement>`
    :param project_entitlements: Relation between a project and the member's effective permissions in that project.
    :type project_entitlements: list of :class:`ProjectEntitlement <member-entitlement-management.v5_1.models.ProjectEntitlement>`
...
class GroupOperationResult(BaseOperationResult):
    ...
    :type result: :class:`GroupEntitlement <member-entitlement-management.v5_1.models.GroupEntitlement>`
    """
...
class GroupOption(Model):
    ...
    :type access_level: :class:`AccessLevel <member-entitlement-management.v5_1.models.AccessLevel>`
    :param group: Group
    :type group: :class:`Group <member-entitlement-management.v5_1.models.Group>`
    """
...
class MemberEntitlementsResponseBase(Model):
    ...
    :type member_entitlement: :class:`MemberEntitlement <member-entitlement-management.v5_1.models.MemberEntitlement>`
    """
...
class OperationResult(Model):
    ...
    :type result: :class:`MemberEntitlement <member-entitlement-management.v5_1.models.MemberEntitlement>`
    """
...
class ProjectEntitlement(Model):
    ...
    :type project_ref: :class:`ProjectRef <member-entitlement-management.v5_1.models.ProjectRef>`
    :param team_refs: Team Ref.
    :type team_refs: list of :class:`TeamRef <member-entitlement-management.v5_1.models.TeamRef>`
    """
...
class UsersSummary(Model):
    ...
    :type available_access_levels: list of :class:`AccessLevel <member-entitlement-management.v5_1.models.AccessLevel>`
    :param extensions: Summary of Extensions in the organization
    :type extensions: list of :class:`ExtensionSummaryData <member-entitlement-management.v5_1.models.ExtensionSummaryData>`
    :param group_options: Group Options
    :type group_options: list of :class:`GroupOption <member-entitlement-management.v5_1.models.GroupOption>`
    :param licenses: Summary of Licenses in the organization
    :type licenses: list of :class:`LicenseSummaryData <member-entitlement-management.v5_1.models.LicenseSummaryData>`
    :param project_refs: Summary of Projects in the organization
    :type project_refs: list of :class:`ProjectRef <member-entitlement-management.v5_1.models.ProjectRef>`
    """
...
class UserEntitlement(Model):
    ...
    :type extensions: list of :class:`Extension <member-entitlement-management.v5_1.models.Extension>`
    :param group_assignments: [Readonly] GroupEntitlements that this user belongs to.
    :type group_assignments: list of :class:`GroupEntitlement <member-entitlement-management.v5_1.models.GroupEntitlement>`
    ...
    :type user: :class:`GraphUser <member-entitlement-management.v5_1.models.GraphUser>`
    """
...
class UserEntitlementsResponseBase(Model):
    ...
    :type user_entitlement: :class:`UserEntitlement <member-entitlement-management.v5_1.models.UserEntitlement>`
    """
...
class UserEntitlementOperationReference(OperationReference):
    ...
    :type results: list of :class:`UserEntitlementOperationResult <member-entitlement-management.v5_1.models.UserEntitlementOperationResult>`
    """
...
class UserEntitlementOperationResult(Model):
    ...
    :type is_success: bool
    :param result: Result of the MemberEntitlement after the operation.
    :type result: :class:`UserEntitlement <member-entitlement-management.v5_1.models.UserEntitlement>`
...
class GroupEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation.
    :type results: list of :class:`GroupOperationResult <member-entitlement-management.v5_1.models.GroupOperationResult>`
    """
...
class MemberEntitlement(UserEntitlement):
    ...
    :type member: :class:`GraphMember <member-entitlement-management.v5_1.models.GraphMember>`
    """
...
class MemberEntitlementsPatchResponse(MemberEntitlementsResponseBase):
    ...
    :type operation_results: list of :class:`OperationResult <member-entitlement-management.v5_1.models.OperationResult>`
    """
...
class MemberEntitlementsPostResponse(MemberEntitlementsResponseBase):
    ...
    :type operation_result: :class:`OperationResult <member-entitlement-management.v5_1.models.OperationResult>`
    """
...
class MemberEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation
    :type results: list of :class:`OperationResult <member-entitlement-management.v5_1.models.OperationResult>`
    """
...
class UserEntitlementsPatchResponse(UserEntitlementsResponseBase):
    ...
    :type user_entitlement: :class:`UserEntitlement <member-entitlement-management.v5_1.models.UserEntitlement>`
    :param operation_results: List of results for each operation.
    :type operation_results: list of :class:`UserEntitlementOperationResult <member-entitlement-management.v5_1.models.UserEntitlementOperationResult>`
    """
...
class UserEntitlementsPostResponse(UserEntitlementsResponseBase):
    ...
    :type user_entitlement: :class:`UserEntitlement <member-entitlement-management.v5_1.models.UserEntitlement>`
    :param operation_result: Operation result.
    :type operation_result: :class:`UserEntitlementOperationResult <member-entitlement-management.v5_1.models.UserEntitlementOperationResult>`
    """
