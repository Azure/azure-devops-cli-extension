...
class GitRepository(Model):
    ...
    :type parent_repository: :class:`GitRepositoryRef <microsoft.-team-foundation.-source-control.-web-api.v5_1.models.GitRepositoryRef>`
    :param project:
...
class WikiAttachmentResponse(Model):
    ...
    :type attachment: :class:`WikiAttachment <wiki.v5_1.models.WikiAttachment>`
...
class WikiCreateParametersV2(WikiCreateBaseParameters):
    ...
    :type version: :class:`GitVersionDescriptor <wiki.v5_1.models.GitVersionDescriptor>`
    """
...
class WikiPageMoveResponse(Model):
    ...
    :type page_move: :class:`WikiPageMove <wiki.v5_1.models.WikiPageMove>`
    """
...
class WikiPageResponse(Model):
    ...
    :type page: :class:`WikiPage <wiki.v5_1.models.WikiPage>`
    """
...
class WikiUpdateParameters(Model):
    ...
    :type versions: list of :class:`GitVersionDescriptor <wiki.v5_1.models.GitVersionDescriptor>`
    """
...
class WikiPage(WikiPageCreateOrUpdateParameters):
    ...
    :type sub_pages: list of :class:`WikiPage <wiki.v5_1.models.WikiPage>`
