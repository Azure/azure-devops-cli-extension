...
class WikiClient(VssClient):
    ...
    def create_attachment(self, upload_stream, project, wiki_identifier, name, **kwargs):
        ...
        :rtype: :class:`<WikiAttachmentResponse> <wiki.v5_1.models.WikiAttachmentResponse>`
        """
        route_values = {}
    ...
    def create_page_move(self, page_move_parameters, project, wiki_identifier, comment=None):
        ...
        :param :class:`<WikiPageMoveParameters> <wiki.v5_1.models.WikiPageMoveParameters>` page_move_parameters: Page more operation parameters.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki Id or name.
        :param str comment: Comment that is to be associated with this page move.
        :rtype: :class:`<WikiPageMoveResponse> <wiki.v5_1.models.WikiPageMoveResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_or_update_page(self, parameters, project, wiki_identifier, path, version, comment=None):
        ...
        :param :class:`<WikiPageCreateOrUpdateParameters> <wiki.v5_1.models.WikiPageCreateOrUpdateParameters>` parameters: Wiki create or update operation parameters.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki Id or name.
        ...
        :rtype: :class:`<WikiPageResponse> <wiki.v5_1.models.WikiPageResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_page(self, project, wiki_identifier, path=None, recursion_level=None, version_descriptor=None, include_content=None):
        ...
        :param :class:`<GitVersionDescriptor> <wiki.v5_1.models.GitVersionDescriptor>` version_descriptor: GitVersionDescriptor for the page. Defaults to the default branch (Optional).
    ...
    def update_page_by_id(self, parameters, project, wiki_identifier, id, version, comment=None):
        ...
        :param :class:`<WikiPageCreateOrUpdateParameters> <wiki.v5_1.models.WikiPageCreateOrUpdateParameters>` parameters: Wiki update operation parameters.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki Id or name.
        :param int id: Wiki page id.
        :param String version: Version of the page on which the change is to be made. Mandatory for `Edit` scenario. To be populated in the If-Match header of the request.
    ...
    def create_wiki(self, wiki_create_params, project=None):
        ...
        :param :class:`<WikiCreateParametersV2> <wiki.v5_1.models.WikiCreateParametersV2>` wiki_create_params: Parameters for the wiki creation.
        :param str project: Project ID or project name
        :rtype: :class:`<WikiV2> <wiki.v5_1.models.WikiV2>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_wiki(self, update_parameters, wiki_identifier, project=None):
        ...
        :param :class:`<WikiUpdateParameters> <wiki.v5_1.models.WikiUpdateParameters>` update_parameters: Update parameters.
        :param str wiki_identifier: Wiki name or Id.
        :param str project: Project ID or project name
        :rtype: :class:`<WikiV2> <wiki.v5_1.models.WikiV2>`
        """
