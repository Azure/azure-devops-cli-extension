...
class WorkClient(VssClient):
    ...
    def get_backlog_configurations(self, team_context):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<BacklogConfiguration> <work.v5_1.models.BacklogConfiguration>`
        """
        project = None
        team = None
    ...
    def get_backlog_level_work_items(self, team_context, backlog_id):
        ...
        :rtype: :class:`<BacklogLevelWorkItems> <work.v5_1.models.BacklogLevelWorkItems>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_backlog(self, team_context, id):
        ...
        :rtype: :class:`<BacklogLevelConfiguration> <work.v5_1.models.BacklogLevelConfiguration>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_board(self, team_context, id):
        ...
        :rtype: :class:`<Board> <work.v5_1.models.Board>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_board_user_settings(self, team_context, board):
        ...
        :rtype: :class:`<BoardUserSettings> <work.v5_1.models.BoardUserSettings>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_capacity_with_identity_ref(self, team_context, iteration_id, team_member_id):
        ...
        :rtype: :class:`<TeamMemberCapacityIdentityRef> <work.v5_1.models.TeamMemberCapacityIdentityRef>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_capacity_with_identity_ref(self, patch, team_context, iteration_id, team_member_id):
        ...
        :param :class:`<CapacityPatch> <work.v5_1.models.CapacityPatch>` patch: Updated capacity
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str iteration_id: ID of the iteration
        :param str team_member_id: ID of the team member
        :rtype: :class:`<TeamMemberCapacityIdentityRef> <work.v5_1.models.TeamMemberCapacityIdentityRef>`
    ...
    def get_board_card_rule_settings(self, team_context, board):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str board:
        :rtype: :class:`<BoardCardRuleSettings> <work.v5_1.models.BoardCardRuleSettings>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_board_card_rule_settings(self, board_card_rule_settings, team_context, board):
        ...
        :param :class:`<BoardCardRuleSettings> <work.v5_1.models.BoardCardRuleSettings>` board_card_rule_settings:
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str board:
        :rtype: :class:`<BoardCardRuleSettings> <work.v5_1.models.BoardCardRuleSettings>`
        """
    ...
    def get_board_card_settings(self, team_context, board):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str board:
        :rtype: :class:`<BoardCardSettings> <work.v5_1.models.BoardCardSettings>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_board_card_settings(self, board_card_settings_to_save, team_context, board):
        ...
        :param :class:`<BoardCardSettings> <work.v5_1.models.BoardCardSettings>` board_card_settings_to_save:
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str board:
        :rtype: :class:`<BoardCardSettings> <work.v5_1.models.BoardCardSettings>`
        """
    ...
    def get_board_chart(self, team_context, board, name):
        ...
        :rtype: :class:`<BoardChart> <work.v5_1.models.BoardChart>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_board_chart(self, chart, team_context, board, name):
        ...
        :param :class:`<BoardChart> <work.v5_1.models.BoardChart>` chart:
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str board: Identifier for board, either board's backlog level name (Eg:"Stories") or Id
        :param str name: The chart name
        :rtype: :class:`<BoardChart> <work.v5_1.models.BoardChart>`
    ...
    def get_delivery_timeline_data(self, project, id, revision=None, start_date=None, end_date=None):
        ...
        :rtype: :class:`<DeliveryViewData> <work.v5_1.models.DeliveryViewData>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_team_iteration(self, team_context, id):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str id: ID of the iteration
        :rtype: :class:`<TeamSettingsIteration> <work.v5_1.models.TeamSettingsIteration>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def post_team_iteration(self, iteration, team_context):
        ...
        :param :class:`<TeamSettingsIteration> <work.v5_1.models.TeamSettingsIteration>` iteration: Iteration to add
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TeamSettingsIteration> <work.v5_1.models.TeamSettingsIteration>`
        """
        project = None
    ...
    def create_plan(self, posted_plan, project):
        ...
        :param :class:`<CreatePlan> <work.v5_1.models.CreatePlan>` posted_plan: Plan definition
        :param str project: Project ID or project name
        :rtype: :class:`<Plan> <work.v5_1.models.Plan>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_plan(self, updated_plan, project, id):
        ...
        :param :class:`<UpdatePlan> <work.v5_1.models.UpdatePlan>` updated_plan: Plan definition to be updated
        :param str project: Project ID or project name
        :param str id: Identifier of the plan
        :rtype: :class:`<Plan> <work.v5_1.models.Plan>`
        """
    ...
    def get_process_configuration(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<ProcessConfiguration> <work.v5_1.models.ProcessConfiguration>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_team_days_off(self, team_context, iteration_id):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str iteration_id: ID of the iteration
        :rtype: :class:`<TeamSettingsDaysOff> <work.v5_1.models.TeamSettingsDaysOff>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_team_days_off(self, days_off_patch, team_context, iteration_id):
        ...
        :param :class:`<TeamSettingsDaysOffPatch> <work.v5_1.models.TeamSettingsDaysOffPatch>` days_off_patch: Team's days off patch containting a list of start and end dates
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str iteration_id: ID of the iteration
        :rtype: :class:`<TeamSettingsDaysOff> <work.v5_1.models.TeamSettingsDaysOff>`
        """
    ...
    def get_team_field_values(self, team_context):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TeamFieldValues> <work.v5_1.models.TeamFieldValues>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_team_field_values(self, patch, team_context):
        ...
        :param :class:`<TeamFieldValuesPatch> <work.v5_1.models.TeamFieldValuesPatch>` patch:
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TeamFieldValues> <work.v5_1.models.TeamFieldValues>`
        """
        project = None
    ...
    def get_team_settings(self, team_context):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TeamSetting> <work.v5_1.models.TeamSetting>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def update_team_settings(self, team_settings_patch, team_context):
        ...
        :param :class:`<TeamSettingsPatch> <work.v5_1.models.TeamSettingsPatch>` team_settings_patch: TeamSettings changes
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TeamSetting> <work.v5_1.models.TeamSetting>`
        """
        project = None
    ...
    def get_iteration_work_items(self, team_context, iteration_id):
        ...
        :param :class:`<TeamContext> <work.v5_1.models.TeamContext>` team_context: The team context for the operation
        :param str iteration_id: ID of the iteration
        :rtype: :class:`<IterationWorkItems> <work.v5_1.models.IterationWorkItems>`
        """
        project = None
        team = None
        if team_context is not None:
