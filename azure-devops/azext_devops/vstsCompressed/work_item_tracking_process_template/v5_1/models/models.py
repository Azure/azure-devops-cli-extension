...
class AdminBehavior(Model):
    ...
    :type fields: list of :class:`AdminBehaviorField <work-item-tracking-process-template.v5_1.models.AdminBehaviorField>`
...
class ProcessImportResult(Model):
    ...
    :type validation_results: list of :class:`ValidationIssue <work-item-tracking-process-template.v5_1.models.ValidationIssue>`
    """
