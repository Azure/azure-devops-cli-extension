...
class WorkItemTrackingProcessTemplateClient(VssClient):
    ...
    def get_behavior(self, process_id, behavior_ref_name):
        ...
        :rtype: :class:`<AdminBehavior> <work-item-tracking-process-template.v5_1.models.AdminBehavior>`
        """
        route_values = {}
    ...
    def check_template_existence(self, upload_stream, **kwargs):
        ...
        :rtype: :class:`<CheckTemplateExistenceResult> <work-item-tracking-process-template.v5_1.models.CheckTemplateExistenceResult>`
        """
        route_values = {}
    ...
    def import_process_template(self, upload_stream, ignore_warnings=None, **kwargs):
        ...
        :rtype: :class:`<ProcessImportResult> <work-item-tracking-process-template.v5_1.models.ProcessImportResult>`
        """
        route_values = {}
    ...
    def import_process_template_status(self, id):
        ...
        :rtype: :class:`<ProcessPromoteStatus> <work-item-tracking-process-template.v5_1.models.ProcessPromoteStatus>`
        """
        route_values = {}
        if id is not None:
            route_values['id'] = self._serialize.url('id', id, 'str')
