...
class PolicyConfigurationRef(Model):
    ...
    :type type: :class:`PolicyTypeRef <policy.v5_1.models.PolicyTypeRef>`
...
class PolicyEvaluationRecord(Model):
    ...
    :type _links: :class:`ReferenceLinks <policy.v5_1.models.ReferenceLinks>`
    ...
    :type configuration: :class:`PolicyConfiguration <policy.v5_1.models.PolicyConfiguration>`
    :param context: Internal context data of this policy evaluation.
    :type context: :class:`object <policy.v5_1.models.object>`
...
class PolicyConfiguration(VersionedPolicyConfigurationRef):
    ...
    :type created_by: :class:`IdentityRef <policy.v5_1.models.IdentityRef>`
    ...
    :type settings: :class:`object <policy.v5_1.models.object>`
    """
