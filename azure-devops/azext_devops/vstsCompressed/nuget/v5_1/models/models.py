...
class NuGetPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <nuGet.v5_1.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <nuGet.v5_1.models.MinimalPackageDetails>`
    """
...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <nuGet.v5_1.models.ReferenceLinks>`
    ...
    :type source_chain: list of :class:`UpstreamSourceInfo <nuGet.v5_1.models.UpstreamSourceInfo>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <nuGet.v5_1.models.JsonPatchOperation>`
    """
