...
class NuGetClient(VssClient):
    ...
    def update_package_versions(self, batch_request, feed_id):
        ...
        :param :class:`<NuGetPackagesBatchRequest> <nuGet.v5_1.models.NuGetPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data.
        :param str feed_id: Name or ID of the feed.
        """
        route_values = {}
        if feed_id is not None:
    ...
    def get_package_version_metadata_from_recycle_bin(self, feed_id, package_name, package_version):
        ...
        :param str package_name: Name of the package.
        :param str package_version: Version of the package.
        :rtype: :class:`<NuGetPackageVersionDeletionState> <nuGet.v5_1.models.NuGetPackageVersionDeletionState>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def restore_package_version_from_recycle_bin(self, package_version_details, feed_id, package_name, package_version):
        ...
        :param :class:`<NuGetRecycleBinPackageVersionDetails> <nuGet.v5_1.models.NuGetRecycleBinPackageVersionDetails>` package_version_details: Set the 'Deleted' member to 'false' to apply the restore operation
        :param str feed_id: Name or ID of the feed.
        :param str package_name: Name of the package.
        :param str package_version: Version of the package.
        """
    ...
    def delete_package_version(self, feed_id, package_name, package_version):
        ...
        :rtype: :class:`<Package> <nuGet.v5_1.models.Package>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
    ...
    def update_package_version(self, package_version_details, feed_id, package_name, package_version):
        ...
        :param :class:`<PackageVersionDetails> <nuGet.v5_1.models.PackageVersionDetails>` package_version_details: New state to apply to the referenced package.
        :param str feed_id: Name or ID of the feed.
