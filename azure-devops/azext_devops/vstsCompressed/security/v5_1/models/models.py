...
class AccessControlEntry(Model):
    ...
    :type descriptor: :class:`str <security.v5_1.models.str>`
    ...
    :type extended_info: :class:`AceExtendedInformation <security.v5_1.models.AceExtendedInformation>`
    """
...
class PermissionEvaluationBatch(Model):
    ...
    :type evaluations: list of :class:`PermissionEvaluation <security.v5_1.models.PermissionEvaluation>`
    """
...
class SecurityNamespaceDescription(Model):
    ...
    :type actions: list of :class:`ActionDefinition <security.v5_1.models.ActionDefinition>`
