...
def add_work_item_tags(id, tag, organization=None, detect=None):  # pylint: disable=redefined-builtin
    ...
    work_item = update_work_item(id, fields=['System.Tags={}'.format(tag)], organization=organization, detect=detect)
    return work_item
...
def list_work_item_tags(id, organization=None, detect=None):  # pylint: disable=redefined-builtin
    ...
    work_item = show_work_item(id, fields='System.Id,System.Tags', expand=None, organization=organization, detect=detect)
    return work_item
