...
def update_policy_approver_count(policy_id,
    ...
    param_value_array = [
        ...
        allow_downvotes if creator_vote_counts is not None else current_setting.get('allowDownvotes', None),
    ...
    updated_configuration = create_configuration_object(
        ...
        is_blocking if is_blocking is not None else str(current_policy.is_blocking),
        is_enabled if is_enabled is not None else str(current_policy.is_enabled),
        'fa4e907d-c16b-4a4c-9dfa-4906e5d171dd',
        param_name_array,
        param_value_array,
