...
class TestWorkItemMethods(unittest.TestCase):
    ...
    def test_show_work_item_correct_id(self):
        ...
        response = show_work_item(id=test_work_item_id, devops_organization=self._TEST_DEVOPS_ORGANIZATION)
    ...
    def test_show_work_item_correct_id_open_browser(self):
        ...
        response = show_work_item(id=test_work_item_id, open_browser=True, devops_organization=self._TEST_DEVOPS_ORGANIZATION)
    ...
    def test_delete_work_item_correct_id(self):
        ...
        response = delete_work_item(id=test_work_item_id, destroy=False, devops_organization=self._TEST_DEVOPS_ORGANIZATION, detect='Off')
    ...
    def test_delete_work_item_raises_exception_invalid_id(self):
        ...
        with self.assertRaises(Exception) as exc:
            response = delete_work_item(id=test_work_item_id, devops_organization=self._TEST_DEVOPS_ORGANIZATION)
        self.assertEqual(str(exc.exception),r'TF401232: Work item 1000 does not exist, or you do not have permissions to read it.')
