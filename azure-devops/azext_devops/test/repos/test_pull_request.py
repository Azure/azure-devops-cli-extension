...
class TestPullRequestMethods(unittest.TestCase):
    ...
    def tearDown(self):
        self.create_PR_patcher.stop()
        self.udpate_PR_patcher.stop()
        self.get_PR_byId_patcher.stop()
        self.get_PR_patcher.stop()
        self.get_PRsByProject_patcher.stop()
        self.get_PRs_patcher.stop()
        self.create_PR_reviewers_patcher.stop()
        self.create_PR_reviewer_patcher.stop()
        self.delete_PR_reviewers_patcher.stop()
        self.get_PR_reviewers_patcher.stop()
        self.get_PR_WIs_patcher.stop()
        self.resolve_identity_patcher.stop()
        self.get_credential_patcher.stop()
        self.open_in_browser_patcher.stop()
        self.validate_token_patcher.stop()
        self.resolve_reviewers_as_refs_patcher.stop()
        self.resolve_reviewers_as_ids.stop()
        self.update_WI_patcher.stop()
        self.get_WIs_pacther.stop()
        self.get_policy_evaluation_patcher.stop()
        self.requeue_policy_evaluation_patcher.stop()
